// initially copied from setup_s092_034_2024.C

#include "Riostream.h"

void setup_s181_010_2024()
{
...
return;
 ...
 /*
  ...
  frs->dist_S4target= 5450.0; // FRS-IC beam window / fluorecencs screen  estimated
...
//  MUSIC41 velocity 20.05.2024 100Mo  //S160
  id->vel_a[0] =  609.38;//11402.83;//13427.0; //  MUSIC41 velocity corr. //
  id->vel_a[1] =   1167.8;//-18501.54;//-22587.0;   // 
  id->vel_a[2] =   0.0;//8760.01;//11104.0; //
  id->vel_a[3] =   0.0;
...
// MUSIC42 velocity 20.05.2024 100Mo //S160
  id->vel_a2[0] =  478.15;//12077.07;//14965.0; //
  id->vel_a2[1] = 1219.4;//-20304.94;//-26209.0; //
  id->vel_a2[2] =  0.0;//9864.92;//13201.0;//
  id->vel_a2[3] =  0.0;

  //MUSIC43 velocity corr. (old)
  id->vel_a3[0] =  29030.0; //13951.37; 
  id->vel_a3[1] =  -19790.0;//-38369.9;
  id->vel_a3[2] =  3635.0;//28396.46;
  id->vel_a3[3] =  0.0;
...
//TOF_SC41_SC21_TAC 21.03.24 Au engrun,  
  ...
  //range
  //=========
  range->s4_matter = 2897.0 + 70.0; //mg/cm2
