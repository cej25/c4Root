void lisa_config(const std::string& config_path)
{
    ...
    TLisaConfiguration::SetGMFile(config_path + "/Lisa_GainMatching_5x5_Versoek_0-180deg_v4.txt");
    ...
    // ::: MWD parameters
    TLisaConfiguration::SetMWDParametersFile(config_path + "/Lisa_MWD_Parameters_v2.txt");
