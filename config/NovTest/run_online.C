...
{   
    ...
    TString outputpath = "/u/despec/BB7-c4-test/outputfiles/output";
    ...
    TString ucesb_path = "/u/despec/BB7-c4-test/c4Root/unpack/exps/NovTest/NovTest --allow-errors --input-buffer=200Mi --event-sizes"; // CEJ: R3B used input-buffer, can't see in ucesb doc however...
    ...
    unpackbplast->SetInputFileFineTimeHistos("/u/despec/BB7-c4-test/macros/fine_time_histos_111223_bplast.root");
    ...
    calfatima->SetDetectorCalFile("/u/despec/BB7-c4-test/macros/fatima_cal.txt");
    ...
    calbplast->SetDetectorMapFile("/u/despec/BB7-c4-test/macros/bplast_allocation_111223.txt");
