        ...
        TRangeParameter* range)
{
 ...
 //=============distances=============//
  ...
  frs->bfield[2] = 5.8981;// run4 56Fe F2-F3
  ...
  sci->mhtdc_offset_41_21  =  183.84416; // EG shiyan 05/09/25 (+ 0.419) (579 for frag?) //183.4148170;//183.4148170 + 0.010343;//Updated 09/05/2025 ns update //G-22-103 56Fe
  ...
  id->a2AoQCorr = +0.001; // EG adjusted correction for primary S092 - sept2025 // 0.0012; //0.0012; //2020April12 JP
  id->a4AoQCorr = 0.0;
...
//  sci->mhtdc_offset_21_11[0] = 142.5-16.35;//estimated from pulser data //roughly calibrated 08.02.25
  sci->mhtdc_offset_21_11[0] = 125.064276878; // EG 5/09/25 - shiyan primary (+0.085) // 142.5-16.35+1.093576878 - 2.2343; //correction added online, 2025/May/09
