        ...
        TRangeParameter* range)
{
 ...
 //=============distances=============//
  ...
  //=============switches=============//
  id->x_s2_select   = 2; //1=tpc,2=sc21,3=sc22 // CEJ switch to 2
  ...
  //S1S2 PID options
  id->use_sc11x = 1; //0 = brho from TA-S2, no s1 x used, 1 = x from sc11 lr dt // CEJ switch to 1
  ...
  sci->mhtdc_offset_41_21  =  183.4148170 + 0.010343;//Updated 09/05/2025 ns update //G-22-103 56Fe
...
//  sci->mhtdc_offset_21_11[0] = 142.5-16.35;//estimated from pulser data //roughly calibrated 08.02.25
  sci->mhtdc_offset_21_11[0] = 142.5-16.35+1.093576878 - 2.2343; //correction added online, 2025/May/09
