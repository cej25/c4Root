        ...
        TRangeParameter* range)
{
 ...
 //=============distances=============//
  ...
  frs->bfield[0] = 6.1631;// run4 56Fe TA2-F1
  frs->bfield[1] = 6.0385;// run4 56Fe F1-F2
  frs->bfield[2] = 5.3250;// run4 56Fe F2-F3
  frs->bfield[3] = 5.3250;// run4 56Fe F3-F4
  ...
  sci->mhtdc_offset_41_21  =  184.00416; // EG offline 09/25 // 183.4148170 + 0.010343;//Updated 09/05/2025 ns update //G-22-103 56Fe
  ...
  //not related for S8
  id->a1AoQCorr = - 0.0008; //EG offline 09/25 //0.0; //s1-s2 - actually correction for angle at s2 as there is no angle measurement at s1
  id->a2AoQCorr =  0.0011; // EG offline 09/25; 0.0012; //0.0012; //2020April12 JP
  id->a4AoQCorr = 0.0;
...
// MUSIC42 velocity 
 ...
 //  MUSIC21 velocity MHTDC 
  ...
  id->mhtdc_vel_a_music21_s1s2[0] = 2964.45; // EG offline calibration adjusted on primary cal// 957.52+770;//1610.668662; // online, 2025/Feb/27 (YT) 2025/05/09
  id->mhtdc_vel_a_music21_s1s2[1] = 8403.935;// EG offline calibration adjusted on primary cal //8927.7;//7632.695383; // online, 2025/Feb/27 (YT) 2025/05/09
  ...
  id->mhtdc_vel_a_music41[1] = 878.0; //EG 09/2025// 888.9;//1097.9367;// updated 2025/04/02 2025/05/09
...
//  sci->mhtdc_offset_21_11[0] = 142.5-16.35;//estimated from pulser data //roughly calibrated 08.02.25
  sci->mhtdc_offset_21_11[0] = 142.5 - 16.35 + 1.093576878 - 2.0343; // EG offline 09/25 // 142.5-16.35+1.093576878 - 2.2343; //correction added online, 2025/May/09
