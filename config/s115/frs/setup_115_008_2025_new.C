// initially copied from setup_056_Br_test_2025.C

#include "Riostream.h"

void setup_115_008_2025_new()
{
  ...
  frs->magnification[6] = 1.442848; //S2-S3, just copied as S1-S2, need change to real value, XXu, 21.02.2025
  frs->dispersion[6]    = 3.389088; //S2-S3, just copied as S1-S2, need change to real value, XXu, 21.02.2025
  //=============distances=============//
  //S1
  ...
  frs->bfield[0] = 9.6816;// 70Br
  frs->bfield[1] = 8.8561;
  frs->bfield[2] = 5.6924;// 70Br
  frs->bfield[3] = 5.6924;//
