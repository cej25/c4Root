        ...
        TRangeParameter* range)
{
  ...
  */
  ...
  //MUSIC43
  music->music43_e_off[0]   = 0.; //MUSIC3 offsets
  ...
  music->music43_e_gain[0]   = 1.; // MUSIC3 gains
  ...
  music->music41_pos_a[0]   =      2545.85; // 2540.78; //2540.27;     //0.998;   // C0...Cn position correction not used
  music->music41_pos_a[1]   =    0.0351879; // 0.0745079; //-0.00853985;  //-1.991e-5;
  music->music41_pos_a[2]   = -0.000556786; // 0.00154773;//-0.000832759; //1.969e-6;
  music->music41_pos_a[3]   = -1.20745e-05; //-2.34361e-5; //2.90313e-6;   //1.114e-8;
  music->music41_pos_a[4]   =  -8.1567e-08; //-8.04959e-7;//-2.03174e-7; //-3.841e-10;
  music->music41_pos_a[5]   =    9.288e-10; // 2.65658e-9;         //-2.950e-13;
  music->music41_pos_a[6]   = -2.38042e-11; // 1.73325e-11;

  music->music42_pos_a[0]   =      2491.84; //2477.01; //2477.06;   //0.998;   // C0...Cn position correction not used
  music->music42_pos_a[1]   =    0.0416205; //0.0485704; //0.0222151; //-1.991e-5;
  music->music42_pos_a[2]   =  7.65082e-05; //0.000521307; //0.000331552; //1.969e-6;
  music->music42_pos_a[3]   = -1.28572e-05; //-2.15519e-5; //-4.83731e-6; //1.114e-8;
  music->music42_pos_a[4]   = -2.45176e-07; //-4.11621e-7; //-3.49479e-7; //-3.841e-10;
  music->music42_pos_a[5]   =   1.0122e-09; //1.9045e-9; //0.0;         //-2.950e-13;
  music->music42_pos_a[6]   = -1.24598e-11; //4.46969e-12; //0.0;

  music->music43_pos_a[0]   = 0; //0.998;   // C0...Cn position correction not used
  music->music43_pos_a[1]   = 1; //-1.991e-5;
  music->music43_pos_a[2]   = 0; //1.969e-6;
  music->music43_pos_a[3]   = 0; //1.114e-8;
  music->music43_pos_a[4]   = 0; //-3.841e-10;
  music->music43_pos_a[5]   = 0; //-2.950e-13;
  music->music43_pos_a[6]   = 0; //0.0;
...
//  MUSIC41 velocity 22.03.2024 170Er //S100
  /*
  id->vel_music41_a[0] =   11402.83;//13427.0; //  MUSIC41 velocity corr. //
  id->vel_music41_a[1] =   -18501.54;//-22587.0;   // 
  id->vel_music41_a[2] =   8760.01;//11104.0; //
  id->vel_music41_a[3] =   0.0;
  */

  id->vel_music41_a[0] = 11464.4;
  id->vel_music41_a[1] = -18666.2;
  id->vel_music41_a[2] = 8867.27;
  id->vel_music41_a[3] = 0.0;
  id->vel_music42_a[0] = 12092;
  id->vel_music42_a[1] = -20342.1;
  id->vel_music42_a[2] = 9887.57;
...
// MUSIC42 velocity 22.03.2024 170Er //S100
  /*
  id->vel_music42_a[0] =  12077.07;//14965.0; //
  id->vel_music42_a[1] = -20304.94;//-26209.0; //
  id->vel_music42_a[2] =  9864.92;//13201.0;//
  id->vel_music42_a[3] =  0.0;
  */

  //MUSIC43 velocity corr. (old)
  id->vel_music43_a[0] =  4825.0; //13951.37; 
  id->vel_music43_a[1] =  -4212.0;//-38369.9;
  id->vel_music43_a[2] =  2046;//28396.46;
