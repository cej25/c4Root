        ...
        TRangeParameter* range)
{
  ...
  frs->bfield[0] = 13.9668;    // 170Er 
  frs->bfield[1] = 13.9668;    // 170Er  
  frs->bfield[2] = 13.1523;//;11.5358;   //  170Er
  frs->bfield[3] = 13.1523;//11.5358;   //  170Er
...
// MUSIC42 velocity 22.03.2024 170Er //S100
  ...
  id->vel_a3[0] =  24547;// 4825.0; //13951.37;  // 3925.40
  id->vel_a3[1] =  -45966;// -4212.0;//-38369.9;  // -2915.05
  id->vel_a3[2] =  24149; //2046;//28396.46; // 1580.95
  id->vel_a3[3] =  0.0;
