...
return;
 ...
 /*
  ...
  frs->bfield[0] = 13.7622;    // 234U, 1000 MeV/u, eng run  
  frs->bfield[1] = 13.7622;    // 234U, 1000 MeV/u, eng run
  frs->bfield[2] = 11.6661;   //  234U, 1000 MeV/u, eng run 
  frs->bfield[3] = 11.6661;   //  234U, 1000 MeV/u, eng run
