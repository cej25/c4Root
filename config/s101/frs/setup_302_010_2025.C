...
void setup_302_010_2025()
{
  ...
  frs->bfield[0] = 8.8064; // 84Mo 1GeV
  frs->bfield[1] = 8.8064; 
  frs->bfield[2] = 6.9400; // 84Mo 1GeV
  frs->bfield[3] = 6.9400;
  ...
  //  MUSIC41 velocity correction			
  id->mhtdc_vel_a_music41[0] =  	399.5518611	;// updated 	2025/02/21
  id->mhtdc_vel_a_music41[1] =  	1070.834029	;// updated 	2025/02/21
  id->mhtdc_vel_a_music41[2] =  	0	;// updated 	2025/02/21
  id->mhtdc_vel_a_music41[3] =  	0	;// updated 	2025/02/21			
  //  MUSIC42 velocity correction			
  id->mhtdc_vel_a_music42[0] =  	406.8529495	;// updated 	2025/02/21
  id->mhtdc_vel_a_music42[1] =  	1049.666391	;// updated 	2025/02/21
  id->mhtdc_vel_a_music42[2] =  	0	;// updated 	2025/02/21
  id->mhtdc_vel_a_music42[3] =  	0	;// updated 	2025/02/21
