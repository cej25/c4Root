        ...
        TRangeParameter* range)
{
 ...
 //=============distances=============//
  ...
  frs->primary_z = 26.;
  id->min_aoq_plot = 2.0;
  id->max_aoq_plot = 2.57;
  id->min_z_plot   = 16;
  id->max_z_plot   = 28;

  // bfield (Tm) for new control system. (we put rho = 1)
  frs->bfield[0] = 6.6616;// run4 56Fe TA2-F1
  frs->bfield[1] = 6.5270;// run4 56Fe F1-F2
  frs->bfield[2] = 5.6235;// run4 56Fe F2-F3
  frs->bfield[3] = 5.6235;// run4 56Fe F3-F4
  ...
  // MHTDCAnalysis S2-S4
  id->mhtdc_length_sc2141 =	126.76856671	*0.299792458; //  updated *2	2025/04/02	
  ...
  sci->mhtdc_offset_41_21  =  183.4148170;//Updated 02/04/2025 ns update //G-22-150 208Pb
  ...
  id->a2AoQCorr = 0.0012; //0.0012; //2020April12 JP
  id->a4AoQCorr = 0.0;
...
// MUSIC42 velocity 
 ...
 //  MUSIC21 velocity MHTDC 
  ...
  id->mhtdc_vel_a_music41[0] = 419.9431;//updated 2025/04/02 G-22-150 208Pb
  id->mhtdc_vel_a_music41[1] = 1097.9367;// updated 2025/04/02
  id->mhtdc_vel_a_music41[2] = 0.0;//
  id->mhtdc_vel_a_music41[3] = 0.0;//
  
  //  MUSIC42 velocity MHTDC 
  id->mhtdc_vel_a_music42[0] = 351.698;//updated 2025/04/02 G-22-150 208Pb
  id->mhtdc_vel_a_music42[1] = 1163.352;// updated 2025/04/02
