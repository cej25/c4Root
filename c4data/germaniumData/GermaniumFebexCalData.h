#ifndef GermaniumFebexCalData_H
#define GermaniumFebexCalData_H

#include "TObject.h"

class GermaniumFebexCalData : public TObject
{
    public:
        // Default Constructor
        GermaniumFebexCalData();

        GermaniumFebexCalData(uint32_t num_channels_fired,
    ...
    public:
        ClassDef(GermaniumFebexCalData, 1)
};
