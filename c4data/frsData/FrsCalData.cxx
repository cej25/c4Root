...
void FrsCalSciItem::SetAll(uint32_t de21l,
                        ...
                        uint32_t dt22l_81l,
                        uint32_t dt22r_81r,
                        std::vector<int32_t> sci11_hits,
                        std::vector<int32_t> sci21l_hits,
                        std::vector<int32_t> sci21r_hits,
                        std::vector<int32_t> sci22l_hits,
                        std::vector<int32_t> sci22r_hits,
                        std::vector<int32_t> sci31l_hits,
                        std::vector<int32_t> sci31r_hits,
                        std::vector<int32_t> sci41l_hits,
                        std::vector<int32_t> sci41r_hits,
                        std::vector<int32_t> sci42l_hits,
                        std::vector<int32_t> sci42r_hits,
                        std::vector<int32_t> sci43l_hits,
                        std::vector<int32_t> sci43r_hits,
                        std::vector<int32_t> sci81l_hits,
                        std::vector<int32_t> sci81r_hits)
{
    de_21l = de21l;
    de_21r = de21r;
    de_22l = de22l;
