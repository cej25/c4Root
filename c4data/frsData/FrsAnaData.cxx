#include "FrsAnaData.h"


FrsAnaItem::FrsAnaItem() {}

void FrsAnaItem::SetMetaData(Long64_t wr_t, Short_t tpat)
{
    fwr_t = wr_t;
    ftpat = tpat;
}

void FrsAnaItem::SetScalerData(Double_t time_in_ms,
                Double_t time_in_us,
                Int_t ibin_for_s,
...
void FrsAnaItem::SetSciData(Float_t sci_e_21,
                Float_t sci_x_21,
                Float_t sci_e_22,
                Float_t sci_x_22,
                Float_t sci_e_31,
...
void FrsAnaItem::SetMusicData(Float_t music_dE[2], Float_t music_dE_cor[2])
{
    for (int i = 0; i < 2; i++)
    {
...
void FrsAnaItem::SetIDs(Float_t x2,
            Float_t y2,
            Float_t x4,
            Float_t y4,
            Float_t a2,
...
void FrsAnaItem::SetDriftCorrections(Float_t FRS_time, 
...
FrsAnaMultiItem::FrsAnaMultiItem() {}

void FrsAnaMultiItem::SetAll(Float_t s2x,
                            Float_t s2a,
                            Float_t s4x,
                            Float_t s4a,
                            Float_t tof,
