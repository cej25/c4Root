...
class FrsGate
{
    public:
        ...
        bool PassedS1S2(double Z21, double AoQs1s2, double x2);
        ...
        bool PassedAllGates(double Z21, double x2, double AoQs1s2, double Z41, double Z42, double x4, double AoQs2S4, double dEdegZ41, double sci42E);
