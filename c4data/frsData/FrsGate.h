...
class FrsGate
{
    public:
        ...
        std::string GetName();
        bool PassedGate(double Z1, double Z2, double x2, double x4, double AoQ, double dEdeg, double sci42E);
        ...
        bool Passed_sci42EvsZ(double Z, double sci42E);
        ...
        bool cut_sci42E_exists() {  return cut_sci42E_Z != nullptr; } 
