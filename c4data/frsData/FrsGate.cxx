...
// read gates here.
    ...
    c4LOG(info, Form("PID gate %s loaded with cuts on Z21/AoQs1s2 = %i, Z41/AoQs2s4 = %i, Z21/Z41 = %i, x2/AoQs2s4 = %i, x4/AoQs2s4 = %i, x2/AoQs1s2 = %i, dEdegZ41/Z41 = %i ",
    gate_name.c_str(),
...
bool FrsGate::PassedGate(double Z21, double Z41, double x2, double x4, double AoQs2s4,double AoQs1s2, double dEdegZ41)
{
    ...
    return passed_gate_cut_Z21_AoQs1s2 && passed_gate_cut_Z41_AoQs2s4 && passed_gate_cut_Z21_Z41 && passed_gate_cut_x2_AoQs2s4 && passed_gate_cut_x4_AoQs2s4 && passed_gate_cut_x2_AoQs1s2 && passed_gate_cut_dEdegZ41_Z41;
};
