...
class bPlastTwinpeaksCalData : public TObject
{
    public:
        ...
        inline const std::string Get_detector_stream() const {return fdetector_stream; }
        inline const std::string Get_detector_position() const {return fdetector_position; }
        ...
        void Set_detector_stream(std::string v){ fdetector_stream = v; }
        void Set_detector_position(std::string v){ fdetector_position = v; }
