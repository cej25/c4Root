#ifndef H10MCPTwinpeaksData_H
#define H10MCPTwinpeaksData_H

#include "TObject.h"

class H10MCPTwinpeaksData : public TObject
{
    public:
        // Default Constructor
        H10MCPTwinpeaksData();
    ...
    public:
        ClassDef(H10MCPTwinpeaksData, 1);
};
