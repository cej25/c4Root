...
BetaIonTrees::BetaIonTrees() : BetaIonTrees("BetaIonTrees")
{
...
BetaIonTrees::BetaIonTrees(std::vector<FrsGate*> fgs) : BetaIonTrees("BetaIonTrees")
{
    germanium_config = TGermaniumConfiguration::GetInstance();
    frs_config = TFrsConfiguration::GetInstance();
    bplast_config = TbPlastConfiguration::GetInstance();
...
BetaIonTrees::BetaIonTrees(const TString& name, Int_t verbose)
...
void BetaIonTrees::Exec(Option_t* option)
{
    fNEvents += 1;
...
// in progress
double BetaIonTrees::CalcLL(double time, double lifetime)
{   
...
void BetaIonTrees::FinishEvent()
{

}

void BetaIonTrees::FinishTask()
{
