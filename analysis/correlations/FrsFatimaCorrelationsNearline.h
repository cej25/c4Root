#ifndef FrsFatimaCorrelationsNearline_H
#define FrsFatimaCorrelationsNearline_H
...
class FrsFatimaCorrelationsNearline : public FairTask
{
    public:
        FrsFatimaCorrelationsNearline();
    ...
    public:
        ClassDef(FrsFatimaCorrelationsNearline, 1)
};
