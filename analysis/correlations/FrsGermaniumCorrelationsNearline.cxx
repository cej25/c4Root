        ...
        if (nHits >= 2 && sci41_seen && positive_PID){
            for (int ihit2 = 0; ihit2 < nHits; ihit2 ++){
                ...
                for (int idx_gamma_gate = 0; idx_gamma_gate < gamma_energies_of_interest.size(); idx_gamma_gate++){
                    ...
                    h2_frs_Z_vs_AoQ_reverse_gated[idx_gamma_gate]->Fill(ID_AoQ,ID_z);
                    h2_frs_Z_vs_Z2_reverse_gated[idx_gamma_gate]->Fill(ID_z,ID_z2);
                    h2_frs_x2_vs_AoQ_reverse_gated[idx_gamma_gate]->Fill(ID_AoQ,ID_x2);
                    h2_frs_x4_vs_AoQ_reverse_gated[idx_gamma_gate]->Fill(ID_AoQ,ID_x4);
                }
        ...
        for (int ihit1 = 0; ihit1 < nHits; ihit1 ++){
            ...
            for (int idx_gamma_gate = 0; idx_gamma_gate < gamma_energies_of_interest.size(); idx_gamma_gate++)
            {
                if (!(TMath::Abs(energy_long - gamma_energies_of_interest.at(idx_gamma_gate))<gate_width_gamma_energies_of_interest.at(idx_gamma_gate))) continue;
                    ...
                    h2_frs_Z_vs_AoQ_reverse_wr_gated[idx_gamma_gate]->Fill(ID_AoQ,ID_z);
                    h2_frs_Z_vs_Z2_reverse_wr_gated[idx_gamma_gate]->Fill(ID_z,ID_z2);
                    h2_frs_x2_vs_AoQ_reverse_wr_gated[idx_gamma_gate]->Fill(ID_AoQ,ID_x2);
                    h2_frs_x4_vs_AoQ_reverse_wr_gated[idx_gamma_gate]->Fill(ID_AoQ,ID_x4);
            }
