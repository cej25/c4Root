...
InitStatus FrsOnlineSpectra::Init()
{
    ...
    if (frs_config->plot_tac_2d)
    {
        ...
        h2_Z41_vs_dE42 = MakeTH2(dir_tac_2d_S2S4, "D", "h2_Z41_vs_dE42", "Z41 vs. dE in MUSIC2", 400, frs_config->fMin_Z, frs_config->fMax_Z, 250, frs_config->fMin_dE_Music2, frs_config->fMax_dE_Music2, "Z (MUSIC 41)", "dE in MUSIC 42");
        ...
        h2_dE41_vs_ToF_21_41 = MakeTH2(dir_tac_2d_S2S4, "D", "h2_dE_vs_ToF_21_41", "ToF 21 - 41 vs. dE in MUSIC 41", 2000, 0., 70000., 400, frs_config->fMin_dE_Music1, frs_config->fMax_dE_Music1, "Time of Flight (21 - 41)", "dE in MUSIC 41");
        ...
        h2_dE41_vs_x2 = MakeTH2(dir_tac_2d_S2S4, "D", "h2_dE1_vs_x2", "x2 vs. dE in MUSIC 41", 200, frs_config->fMin_x2, frs_config->fMax_x2, 400, frs_config->fMin_dE_Music1, frs_config->fMax_dE_Music1, "S2 x-position", "dE in MUSIC 41");
        h2_dE41_vs_x4 = MakeTH2(dir_tac_2d_S2S4, "D", "h2_dE1_vs_x4", "x4 vs. dE in MUSIC 41", 200, frs_config->fMin_x4, frs_config->fMax_x4, 400, frs_config->fMin_dE_Music1, frs_config->fMax_dE_Music1, "S4 x-position", "dE in MUSIC 41");
    ...
    if (frs_config->plot_mhtdc_2d)
    {
        ...
        h2_Z41_vs_dE42_mhtdc = MakeTH2(dir_mhtdc_2d_S2S4, "D", "h2_Z41_vs_dE2_mhtdc", "Z41 vs. dE in MUSIC 42 (MHTDC)", 400, frs_config->fMin_Z, frs_config->fMax_Z, 250, frs_config->fMin_dE_Music2, frs_config->fMax_dE_Music2, "Z (MUSIC 41)", "dE in MUSIC 42");
        h2_Z21_vs_dE21_mhtdc = MakeTH2(dir_mhtdc_2d_S1S2, "D", "h2_Z21_vs_dE21_mhtdc", "Z21 vs. dE in MUSIC 21 (MHTDC)", 400, frs_config->fMin_Z, frs_config->fMax_Z, 250, frs_config->fMin_dE_Music1, frs_config->fMax_dE_Music1, "Z (MUSIC 21)", "dE in MUSIC 21");
        ...
        if (!frs_config->plot_tac_2d)
        {
            ...
            h2_dE41_vs_ToF_21_41 = MakeTH2(dir_mhtdc_2d_S2S4, "D", "h2_dE_vs_ToF_21_41", "ToF 21 - 41 vs. dE in MUSIC 41", 2000, 0., 70000., 400, frs_config->fMin_dE_Music1, frs_config->fMax_dE_Music1, "Time of Flight (21 - 41)", "dE in MUSIC 41");
            h2_dE41_vs_x2 = MakeTH2(dir_mhtdc_2d_S2S4, "D", "h2_dE1_vs_x2", "x2 vs. dE in MUSIC 41", 200, frs_config->fMin_x2, frs_config->fMax_x2, 400, frs_config->fMin_dE_Music1, frs_config->fMax_dE_Music1, "S2 x-position", "dE in MUSIC 41");
            h2_dE41_vs_x4 = MakeTH2(dir_mhtdc_2d_S2S4, "D", "h2_dE1_vs_x4", "x4 vs. dE in MUSIC 41", 200, frs_config->fMin_x4, frs_config->fMax_x4, 400, frs_config->fMin_dE_Music1, frs_config->fMax_dE_Music1, "S4 x-position", "dE in MUSIC 41");
