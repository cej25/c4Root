...
InitStatus FrsOnlineSpectra::Init()
{
    ...
    if (frs_config->plot_mhtdc)
    {
        ...
        h1_sci_tof_21_41_mhtdc = MakeTH1(dir_mhtdc_s2s4_1d, "D", "h1_sci_tof_21_41_mhtdc", "SCI 21-41 TOF", 1000, 0, 400, "Time [ns]", kPink-3, kBlue+2);
    ...
    h1_music41_dE = MakeTH1(dir_music_e, "D", "h1_music41_dE", "Energy loss in MUSIC 41", 1000, 0.0, 64000.0, "dE MUSIC 41", kPink-3, kBlue+2);
    h1_music42_dE = MakeTH1(dir_music_e, "D", "h1_music42_dE", "Energy loss in MUSIC 42", 1000, 0.0, 64000.0, "dE MUSIC 42", kPink-3, kBlue+2);
    h1_music41_dE_cor = MakeTH1(dir_music_e, "D", "h1_music41_dE_cor", "Energy loss (cor) in MUSIC 41", 4000, 0.0, 64000.0, "dE (cor) MUSIC 41", kPink-3, kBlue+2);
    h1_music42_dE_cor = MakeTH1(dir_music_e, "D", "h1_music42_dE_cor", "Energy loss (cor) in MUSIC 42", 4000, 0.0, 64000.0, "dE (cor) MUSIC 42", kPink-3, kBlue+2);
...
void FrsOnlineSpectra::Reset_Histo() 
{
    ...
    } else c4LOG(error, "Failed to get list of histograms from directory.");
...
void FrsOnlineSpectra::Process_MHTDC()
{
    int a = 0;
    ...
    for (int i = 0; i < AoQ_s2s4_mhtdc.size(); i++)
    {
        ...
        if (tof_sci21_41.at(i) > 0) h1_sci_tof_21_41_mhtdc->Fill(tof_sci21_41.at(i));
...
void FrsOnlineSpectra::Process_Monitors()
{
