...
InitStatus FrsOnlineSpectra::Init()
{
    ...
    if (frs_config->plot_mhtdc_2d)
    {
        ...
        h2_x2_vs_Z41_mhtdc = MakeTH2(dir_mhtdc_2d_S2S4, "D", "h2_x2_vs_Z4_mhtdc", "x2 vs. Z1 (MHTDC)", 400, frs_config->fMin_Z, frs_config->fMax_Z, 200, frs_config->fMin_x2, frs_config->fMax_x2, "Z (MUSIC 1)", "S2 x-position");
        h2_x4_vs_Z41_mhtdc = MakeTH2(dir_mhtdc_2d_S2S4, "D", "h2_x4_vs_Z41_mhtdc", "x4 vs. Z41 (MHTDC)", 400, frs_config->fMin_Z, frs_config->fMax_Z, 200, frs_config->fMin_x4, frs_config->fMax_x4, "Z (MUSIC 1)", "S4 x-position");
        h2_Z41_vs_Sc21E_mhtdc = MakeTH2(dir_mhtdc_2d_S2S4, "D", "h2_Z41_vs_Sc21E_mhtdc", "Z41 vs. SCI 21 E (MHTDC)", 300, frs_config->fMin_Z, frs_config->fMax_Z, 400, 0., 4000., "Z (MUSIC 1)", "SCI 21 E");
