...
InitStatus GermaniumNearlineSpectra::Init()
{
    ...
    //h2_germanium_energy_vs_detidx = MakeT//h2(dir_germanium_energy, "F", "//h2_germanium_energy_vs_detidx","Calibrated Germanium spectra vs. detector index",fenergy_nbins,fenergy_bin_low,fenergy_bin_high,number_of_detectors_to_plot,0,number_of_detectors_to_plot, "Energy [keV]", "Detector");
    ...
    //h2_germanium_energy_summed_vs_tsci41 = MakeT//h2(dir_germanium_sci41, "F", "//h2_germanium_energy_summed_vs_tsci41","Calibrated Germanium spectra summed all energyies vs t(det) - t(sci41)",1000,-500,5000,fenergy_nbins,fenergy_bin_low,fenergy_bin_high, "Time difference [ns]", "Energy [keV]");
    ...
    //h2_germanium_energy_energy_vetosci41 = MakeT//h2(dir_germanium_sci41, "F", "//h2_germanium_energy_energy_vetosci41","Calibrated Germanium spectra summed all energies, t(det) - t(sci41) > 200 ns",fenergy_nbins,fenergy_bin_low,fenergy_bin_high,fenergy_nbins,fenergy_bin_low,fenergy_bin_high, "Energy [keV]", "Energy [keV]");
    //h2_germanium_energy_energy_sci41_cut = MakeT//h2(dir_germanium_sci41, "F", "//h2_germanium_energy_energy_sci41_cut","Calibrated Germanium spectra summed all energies, t(det) - t(sci41) > 200 ns",fenergy_nbins,fenergy_bin_low,fenergy_bin_high,fenergy_nbins,fenergy_bin_low,fenergy_bin_high, "Energy [keV]", "Energy [keV]");
