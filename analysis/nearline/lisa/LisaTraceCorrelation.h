#ifndef LisaTraceCorrelation_H
#define LisaTraceCorrelation_H
...
class LisaTraceCorrelation : public FairTask
{
    public:
        LisaTraceCorrelation();
        LisaTraceCorrelation(const TString& name, Int_t verbose = 1);

        virtual ~LisaTraceCorrelation();
