...
{   
    ...
    TString outputpath = "/u/jlarsson/Documents/OnlineAnalysisCode/BB7Test/output.root";
    ...
    TString ucesb_path = "/u/jlarsson/Documents/OnlineAnalysisCode/c4Root/unpack/exps/NovTest/NovTest --allow-errors --input-buffer=16Mi"; // CEJ: R3B used input-buffer, can't see in ucesb doc however...
    ...
    unpackbplast->SetInputFileFineTimeHistos("/u/jlarsson/Documents/OnlineAnalysisCode/c4_S450/fine_time_histos_S450.root");
    ...
    calfatima->SetDetectorMapFile("fatima_alloc.txt");
    calfatima->PrintDetectorMap();
    //calfatima->SetTimeMachineChannels(137,136);
    ...
    calbplast->SetDetectorMapFile("fatima_alloc.txt");

    GermaniumRaw2Cal * ge_calib = new GermaniumRaw2Cal();

    ge_calib->SetDetectorMapFile("/u/jlarsson/Documents/OnlineAnalysisCode/c4_S452/Germanium_Detector_Map.txt");
    ge_calib->PrintDetectorMap();

    ge_calib->SetDetectorCalFile("/u/jlarsson/Documents/OnlineAnalysisCode/c4_S452/Germanium_Energy_Calibration.txt");
