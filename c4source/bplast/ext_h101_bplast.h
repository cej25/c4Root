...
typedef struct EXT_STR_h101_BPLAST_t
{
  ...
  uint32_t bplast_tamex4time_coarse /* [0,512] */;
  uint32_t bplast_tamex4time_coarsev[512 EXT_STRUCT_CTRL(bplast_tamex4time_coarse)] /* [0,65535] */;
  uint32_t bplast_tamex4time_fine /* [0,512] */;
  uint32_t bplast_tamex4time_finev[512 EXT_STRUCT_CTRL(bplast_tamex4time_fine)] /* [0,65535] */;
  uint32_t bplast_tamex4time_edge /* [0,512] */;
  uint32_t bplast_tamex4time_edgev[512 EXT_STRUCT_CTRL(bplast_tamex4time_edge)] /* [0,65535] */;
  uint32_t bplast_tamex4time_channel /* [0,512] */;
  uint32_t bplast_tamex4time_channelv[512 EXT_STRUCT_CTRL(bplast_tamex4time_channel)] /* [0,65535] */;
  uint32_t bplast_tamex4time_epoch /* [0,512] */;
  uint32_t bplast_tamex4time_epochv[512 EXT_STRUCT_CTRL(bplast_tamex4time_epoch)] /* [-1,-1] */;
  uint32_t bplast_tamex5event_size /* [-1,-1] */;
  uint32_t bplast_tamex5time_coarse /* [0,512] */;
  uint32_t bplast_tamex5time_coarsev[512 EXT_STRUCT_CTRL(bplast_tamex5time_coarse)] /* [0,65535] */;
  uint32_t bplast_tamex5time_fine /* [0,512] */;
  uint32_t bplast_tamex5time_finev[512 EXT_STRUCT_CTRL(bplast_tamex5time_fine)] /* [0,65535] */;
  uint32_t bplast_tamex5time_edge /* [0,512] */;
  uint32_t bplast_tamex5time_edgev[512 EXT_STRUCT_CTRL(bplast_tamex5time_edge)] /* [0,65535] */;
  uint32_t bplast_tamex5time_channel /* [0,512] */;
  uint32_t bplast_tamex5time_channelv[512 EXT_STRUCT_CTRL(bplast_tamex5time_channel)] /* [0,65535] */;
  uint32_t bplast_tamex5time_epoch /* [0,512] */;
  uint32_t bplast_tamex5time_epochv[512 EXT_STRUCT_CTRL(bplast_tamex5time_epoch)] /* [-1,-1] */;
...
#define EXT_STR_h101_BPLAST_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ...
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                    ...
                    "bplast_tamex4time_epoch",512,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
  ...
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                    ...
                    "bplast_tamex5time_epoch",512,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
