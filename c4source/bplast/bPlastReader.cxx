    ...
    { //per board:
        ...
        for (int it_hits = 0; it_hits < fData->bplast_tamex[it_board_number].event_size/4 - 3 ; it_hits++)
        {
            ...
            */
            ...
            // if (channelid != 0 && channelid != last_channel_read && !last_word_read_was_epoch) { fNevents_lacking_epoch[it_board_number][channelid-1]++; c4LOG(warning, Form("Event lacking epoch in %d",channelid)); continue;}
