#ifndef LisaFastReader_H
#define LisaFastReader_H
...
struct EXT_STR_h101_lisafast_t;
typedef struct EXT_STR_h101_lisafast_t EXT_STR_h101_lisafast;
typedef struct EXT_STR_h101_lisafast_onion_t EXT_STR_h101_lisafast_onion; //we use only this
class ext_data_struct_info;


struct lisafast_last_lead_hit_struct
{
    bool hit = false;
    //uint16_t board_id; ?
    //uint32_t ch_ID; ?
...
class LisaFastReader : public c4Reader
{
    public:
        LisaFastReader(EXT_STR_h101_lisafast_onion*, size_t);

        virtual ~LisaFastReader();
    ...
    private:
        ...
        EXT_STR_h101_lisafast_onion* fData;
