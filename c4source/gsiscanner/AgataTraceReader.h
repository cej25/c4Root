#ifndef AgataTraceReader_H
#define AgataTraceReader_H
...
struct EXT_STR_h101_agata_t;
typedef struct EXT_STR_h101_agata_t EXT_STR_h101_agata;
typedef struct EXT_STR_h101_agata_onion_t EXT_STR_h101_agata_onion;
class ext_data_struct_info;

class AgataTraceReader : public c4Reader
{
    public:
        AgataTraceReader(EXT_STR_h101_agata_onion*, size_t);

        virtual ~AgataTraceReader();
    ...
    private:
        ...
        EXT_STR_h101_agata_onion* fData;
    ...
    public:
        ClassDefOverride(AgataTraceReader, 0);
};
