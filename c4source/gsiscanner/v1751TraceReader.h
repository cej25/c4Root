#ifndef v1751TraceReader_H
#define v1751TraceReader_H
...
struct EXT_STR_h101_vme_t;
typedef struct EXT_STR_h101_vme_t EXT_STR_h101_vme;
typedef struct EXT_STR_h101_vme_onion_t EXT_STR_h101_vme_onion;
class ext_data_struct_info;

class v1751TraceReader : public c4Reader
{
    public:
        v1751TraceReader(EXT_STR_h101_vme_onion*, size_t);

        virtual ~v1751TraceReader();
    ...
    public:
        ClassDefOverride(v1751TraceReader, 0);
};
