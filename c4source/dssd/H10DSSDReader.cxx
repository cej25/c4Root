...
H10DSSDReader::H10DSSDReader(EXT_STR_h101_bbfebex_onion* data, size_t offset)
    :   c4Reader("H10DSSDReader")
    ,   fNEvent(0)
    ,   fData(data)
    ,   fOffset(offset)
    ,   fOnline(kFALSE)
...
H10DSSDReader::~H10DSSDReader()
{
    delete bb7array;
    delete bb7empty;
}

Bool_t H10DSSDReader::Init(ext_data_struct_info* a_struct_info)
{
    Int_t ok;
    c4LOG(info, "");
