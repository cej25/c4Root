...
#include "../frs/frs_s143y2025.spec"
...
SUBEVENT(fimp_subev)
{
    ...
    select several
    {
        data[0] = CLOCK_TDC_EVENT_16PH(sfp_id=1, tdc_id=0); // match sfp ?
        data[1] = CLOCK_TDC_EVENT_16PH(sfp_id=1, tdc_id=1); // match sfp ?
    };
...
EVENT
{
    ...
    frstravmus = travmus_subev(procid=35);
