...
void BARRIER::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(1009,uint32 ,barrier,barrier.u32,0);
  CHECK_BITS_RANGE(1008,barrier.ba,0xf52,0xf58);
  if (__buffer.is_memberdump())
  {
...
void FEBEX_EVENT::__unpack(__data_src_t &__buffer,uint32 card)
{
  ...
  READ_FROM_BUFFER_FULL(268,uint32 ,sumchannel,sumchannel.u32,2);
  ...
  READ_FROM_BUFFER_FULL(276,uint32 ,channel_size,channel_size.u32,3);
  if (__buffer.is_memberdump())
  {
  ...
  READ_FROM_BUFFER_FULL(285,uint32 ,event_timestamp_hi,event_timestamp_hi.u32,4);
  {
  ...
  READ_FROM_BUFFER_FULL(291,uint32 ,event_timestamp_lo,event_timestamp_lo.u32,5);
  {
  ...
  READ_FROM_BUFFER_FULL(299,uint32 ,hp,hp.u32,6);
  {
  ...
  READ_FROM_BUFFER_FULL(304,uint32 ,deadbeef,deadbeef.u32,7);
  ...
  for (uint32 index = 0; index < (uint32) (((channel_size.size / 4) - 1)); ++index)
  {
    ...
    READ_FROM_BUFFER_FULL(315,uint32 ,channelids,channelids.u32,8);
    CHECK_BITS_EQUAL(311,channelids.unnamed_24_31,240);
    {
      typedef __typeof__(*(&(channel_trigger_time_hi))) __array_t;
      typedef typename __array_t::item_t __item_t;
      __item_t &__item = channel_trigger_time_hi.insert_index(314,channelids.channel_id_bits);
    ...
    READ_FROM_BUFFER_FULL(320,uint32 ,channel_ts,channel_ts.u32,9);
    {
      typedef __typeof__(*(&(channel_trigger_time_lo))) __array_t;
      typedef typename __array_t::item_t __item_t;
      __item_t &__item = channel_trigger_time_lo.insert_index(319,channelids.channel_id_bits);
    ...
    READ_FROM_BUFFER_FULL(332,uint32 ,chan_enrgy,chan_enrgy.u32,10);
    {
      {
        typedef __typeof__(*(&(channel_cfd))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = channel_cfd.insert_index(328,channelids.channel_id_bits);
        __item.value = chan_enrgy.TSF;
      }
      {
        typedef __typeof__(*(&(channel_energy))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = channel_energy.insert_index(329,channelids.channel_id_bits);
        __item.value = chan_enrgy.chan_energy;
      }
      {
        typedef __typeof__(*(&(pileup))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = pileup.insert_index(330,channelids.channel_id_bits);
        __item.value = chan_enrgy.pileup_flag;
      }
      {
        typedef __typeof__(*(&(overflow))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = overflow.insert_index(331,channelids.channel_id_bits);
    ...
    READ_FROM_BUFFER_FULL(336,uint32 ,future_use,future_use.u32,11);
...
void FEBEX_EVENT_TRACES::__unpack(__data_src_t &__buffer,uint32 card)
{
  ...
  READ_FROM_BUFFER_FULL(367,uint32 ,sumchannel,sumchannel.u32,13);
  ...
  READ_FROM_BUFFER_FULL(375,uint32 ,channel_size,channel_size.u32,14);
  {
  ...
  READ_FROM_BUFFER_FULL(384,uint32 ,event_timestamp_hi,event_timestamp_hi.u32,15);
  {
    event_trigger_time_hi.value = event_timestamp_hi.timestamp_hi;
  }
  if (__buffer.is_memberdump())
  ...
  READ_FROM_BUFFER_FULL(390,uint32 ,event_timestamp_lo,event_timestamp_lo.u32,16);
  {
    event_trigger_time_lo.value = event_timestamp_lo.timestamp_lo;
  }
  if (__buffer.is_memberdump())
  ...
  READ_FROM_BUFFER_FULL(398,uint32 ,hp,hp.u32,17);
  {
    hit_pattern.value = hp.hp;
  }
  if (__buffer.is_memberdump())
  ...
  READ_FROM_BUFFER_FULL(403,uint32 ,deadbeef,deadbeef.u32,18);
  ...
  if ((sumchannel.trigger_type == 1))
  {
    ...
    for (uint32 index = 0; index < (uint32) (((channel_size.size / 4) - 1)); ++index)
    {
      ...
      READ_FROM_BUFFER_FULL(416,uint32 ,channelids,channelids.u32,19);
      ...
      READ_FROM_BUFFER_FULL(421,uint32 ,channel_ts,channel_ts.u32,20);
      {
        typedef __typeof__(*(&(channel_trigger_time_lo))) __array_t;
        typedef typename __array_t::item_t __item_t;
      ...
      READ_FROM_BUFFER_FULL(433,uint32 ,chan_enrgy,chan_enrgy.u32,21);
      {
        {
          typedef __typeof__(*(&(channel_cfd))) __array_t;
          typedef typename __array_t::item_t __item_t;
      ...
      READ_FROM_BUFFER_FULL(437,uint32 ,future_use,future_use.u32,22);
    ...
    for (uint32 i = 0; i < (uint32) (16); ++i)
    {
      ...
      READ_FROM_BUFFER_FULL(447,uint32 ,header,header.u32,23);
      ...
      READ_FROM_BUFFER_FULL(452,uint32 ,tracesize,tracesize.u32,24);
      if (__buffer.is_memberdump())
      {
      ...
      READ_FROM_BUFFER_FULL(458,uint32 ,tracehead,tracehead.u32,25);
      if (__buffer.is_memberdump())
      {
      ...
      for (uint32 j = 0; j < (uint32) (((tracesize.size / 4) - 2)); ++j)
      {
        ...
        READ_FROM_BUFFER_FULL(478,uint32 ,channel_trace,channel_trace.u32,26);
        {
          {
      ...
      READ_FROM_BUFFER_FULL(487,uint32 ,trace_trailer,trace_trailer.u32,27);
  ...
  else
  {
    ...
    if ((sumchannel.trigger_type == 3))
    {
      ...
      for (uint32 i = 0; i < (uint32) (16); ++i)
      {
        ...
        READ_FROM_BUFFER_FULL(502,uint32 ,header,header.u32,28);
        ...
        READ_FROM_BUFFER_FULL(507,uint32 ,tracesize,tracesize.u32,29);
        if (__buffer.is_memberdump())
        {
          printf("%s%08" PRIx32 "%s: tracesize ", CT_OUT(BOLD), tracesize.u32, CT_OUT(NORM));
          printf(".size=%s%8" PRIx64 "%s ", CT_OUT(BOLD), (uint64_t)  tracesize.size, CT_OUT(NORM));
        ...
        READ_FROM_BUFFER_FULL(513,uint32 ,tracehead,tracehead.u32,30);
        if (__buffer.is_memberdump())
        {
          printf("%s%08" PRIx32 "%s: tracehead ", CT_OUT(BOLD), tracehead.u32, CT_OUT(NORM));
          printf(".other=%s%6" PRIx64 "%s ", CT_OUT(BOLD), (uint64_t)  tracehead.other, CT_OUT(NORM));
        ...
        READ_FROM_BUFFER_FULL(519,uint32 ,trace_trailer,trace_trailer.u32,31);
...
void FEBEX_PADDING::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(240,uint32 ,pads_data,pads_data.u32,33);
...
void VME_CAEN_V830_FRS::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(712,uint32 ,v830_header,v830_header.u32,35);
  CHECK_BITS_EQUAL(710,v830_header.unnamed_26_26,1);
  if (__buffer.is_memberdump())
  {
  ...
  for (uint32 i = 0; i < (uint32) (v830_header.nwords); ++i)
  {
    ...
    READ_FROM_BUFFER_FULL(720,uint32 ,data_word,data_word.u32,36);
    {
      typedef __typeof__(*(&(data))) __array_t;
      typedef typename __array_t::item_t __item_t;
      __item_t &__item = data.insert_index(719,i);
...
void ZERO_FILLER::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(1017,uint32 ,filler,filler.u32,38);
  CHECK_BITS_EQUAL(1016,filler.zero,0);
  if (__buffer.is_memberdump())
  {
...
void VME_CAEN_V792_FRS::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(740,uint32 ,v792_header,v792_header.u32,40);
  CHECK_BITS_EQUAL(735,v792_header.unnamed_14_15,0);
  CHECK_BITS_EQUAL(737,v792_header.unnamed_24_26,2);
  {
  ...
  PEEK_FROM_BUFFER_FULL(756,uint32 ,adc_data,adc_data.u32,41);
  CHECK_JUMP_BITS_EQUAL(752,adc_data.unnamed_24_26,0,data_done_0);
  __buffer.advance(sizeof(adc_data.u32));
  {
    typedef __typeof__(*(&(data))) __array_t;
    typedef typename __array_t::item_t __item_t;
    __item_t &__item = data.insert_index(755,adc_data.channel);
  ...
  READ_FROM_BUFFER_FULL(764,uint32 ,eob,eob.u32,42);
  CHECK_BITS_EQUAL(762,eob.unnamed_24_26,4);
  if (__buffer.is_memberdump())
  {
  ...
  for (uint32 i = 0; i < (uint32) (2); ++i)
  {
    ...
    PEEK_FROM_BUFFER_FULL(773,uint32 ,eob2,eob2.u32,43);
    CHECK_JUMP_BITS_EQUAL(771,eob2.id,6,data_done_1);
...
void TDC_HEADER::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(537,uint32 ,tdc_header,tdc_header.u32,45);
  CHECK_BITS_EQUAL(536,tdc_header.unnamed_27_31,1);
  if (__buffer.is_memberdump())
  {
                                                    ...
                                                    ,raw_array_multi_zero_suppress<DATA8,DATA8,128,128> &leadOrTrail)
{
  ...
  READ_FROM_BUFFER_FULL(553,uint32 ,tdc_data,tdc_data.u32,47);
  CHECK_BITS_EQUAL(549,tdc_data.unnamed_27_31,0);
  {
    {
      typedef __typeof__(*(&(data))) __array_t;
      typedef typename __array_t::item_t __item_t;
      __item_t &__item = data.insert_index(551,tdc_data.chn);
      __item.value = tdc_data.tdc;
    }
    {
      typedef __typeof__(*(&(leadOrTrail))) __array_t;
      typedef typename __array_t::item_t __item_t;
      __item_t &__item = leadOrTrail.insert_index(552,tdc_data.chn);
...
void TDC_ERROR::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(582,uint32 ,tdc_err,tdc_err.u32,49);
  CHECK_BITS_EQUAL(581,tdc_err.unnamed_27_31,4);
  if (__buffer.is_memberdump())
  {
...
void TDC_TRAILER::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(594,uint32 ,tdc_trailer,tdc_trailer.u32,51);
  CHECK_BITS_EQUAL(593,tdc_trailer.unnamed_27_31,3);
  if (__buffer.is_memberdump())
  {
...
void VME_CAEN_V1290_FRS::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(606,uint32 ,header,header.u32,53);
  CHECK_BITS_EQUAL(605,header.unnamed_27_31,8);
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: header ", CT_OUT(BOLD), header.u32, CT_OUT(NORM));
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(614,uint32,__match_peek);
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(610,spurious_match_abort_loop_0,TDC_HEADER);
        UNPACK_DECL(610,TDC_HEADER,tdc_header);
        break;
      case 2:
        CHECK_SPURIOUS_MATCH_DECL(611,spurious_match_abort_loop_0,TDC_DATA_V1290/*,data:member*//*,leadOrTrail:member*/);
        UNPACK_DECL(611,TDC_DATA_V1290,measurement,/*data*/data,/*leadOrTrail*/leadOrTrail);
        break;
      case 3:
        CHECK_SPURIOUS_MATCH_DECL(612,spurious_match_abort_loop_0,TDC_ERROR);
        UNPACK_DECL(612,TDC_ERROR,tdc_err);
        break;
      case 4:
        CHECK_SPURIOUS_MATCH_DECL(613,spurious_match_abort_loop_0,TDC_TRAILER);
        UNPACK_DECL(613,TDC_TRAILER,tdc_trailer);
        break;
    }
  }
  ...
  PEEK_FROM_BUFFER_FULL(621,uint32 ,ext_time_tag,ext_time_tag.u32,54);
  CHECK_JUMP_BITS_EQUAL(620,ext_time_tag.unnamed_27_31,17,data_done_2);
  ...
  READ_FROM_BUFFER_FULL(632,uint32 ,trailer,trailer.u32,55);
  CHECK_BITS_EQUAL(631,trailer.unnamed_27_31,16);
  if (__buffer.is_memberdump())
  {
  ...
  READ_FROM_BUFFER(634,uint32 ,eob,56);
  data_done_3:;
}
...
void MAIN_CRATE_DATA::__unpack(__data_src_t &__buffer)
{
  ...
  // barrier[0] = BARRIER();
  UNPACK_DECL(1023,BARRIER,barrier[0]);
  // v830 = VME_CAEN_V830_FRS();
  UNPACK_DECL(1024,VME_CAEN_V830_FRS,v830);
  // filler[0] = ZERO_FILLER();
  UNPACK_DECL(1026,ZERO_FILLER,filler[0]);
  // barrier[1] = BARRIER();
  UNPACK_DECL(1027,BARRIER,barrier[1]);
  // v792 = VME_CAEN_V792_FRS();
  UNPACK_DECL(1028,VME_CAEN_V792_FRS,v792);
  // barrier[2] = BARRIER();
  UNPACK_DECL(1030,BARRIER,barrier[2]);
  // v1290 = VME_CAEN_V1290_FRS();
  UNPACK_DECL(1031,VME_CAEN_V1290_FRS,v1290);
}
...
void MESYTEC_MQDC32_FRS::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(844,uint32 ,header,header.u32,58);
  CHECK_BITS_EQUAL(840,header.unnamed_12_14,0);
  CHECK_BITS_EQUAL(842,header.unnamed_24_29,0);
  CHECK_BITS_EQUAL(843,header.unnamed_30_31,1);
  CHECK_UNNAMED_BITS_ZERO(844,header.u32,0x00008000);
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: header ", CT_OUT(BOLD), header.u32, CT_OUT(NORM));
  ...
  PEEK_FROM_BUFFER_FULL(855,uint32 ,ch_data,ch_data.u32,59);
  CHECK_JUMP_BITS_EQUAL(851,ch_data.unnamed_21_29,32,data_done_4);
  CHECK_JUMP_BITS_EQUAL(852,ch_data.unnamed_30_31,0,data_done_4);
  CHECK_JUMP_UNNAMED_BITS_ZERO(855,ch_data.u32,0x00007000,data_done_4);
  __buffer.advance(sizeof(ch_data.u32));
  {
    typedef __typeof__(*(&(data))) __array_t;
    typedef typename __array_t::item_t __item_t;
    __item_t &__item = data.insert_index(854,ch_data.channel);
  ...
  PEEK_FROM_BUFFER_FULL(860,uint32 ,zero,zero.u32,60);
  CHECK_JUMP_BITS_EQUAL(859,zero.unnamed_0_31,0,data_done_5);
  ...
  READ_FROM_BUFFER_FULL(866,uint32 ,end_of_event,end_of_event.u32,61);
  CHECK_BITS_EQUAL(865,end_of_event.unnamed_30_31,3);
  if (__buffer.is_memberdump())
  {
...
void MESYTEC_MTDC32_FRS::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(882,uint32 ,header,header.u32,63);
  CHECK_BITS_EQUAL(880,header.unnamed_24_29,0);
  CHECK_BITS_EQUAL(881,header.unnamed_30_31,1);
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: header ", CT_OUT(BOLD), header.u32, CT_OUT(NORM));
    printf(".word_number=%s%3" PRIx64 "%s ", CT_OUT(BOLD), (uint64_t)  header.word_number, CT_OUT(NORM));
  ...
  for (uint32 index = 1; index < (uint32) (header.word_number); ++index)
  {
    ...
    PEEK_FROM_BUFFER_FULL(890,uint32 ,zero,zero.u32,64);
    CHECK_JUMP_BITS_EQUAL(889,zero.ze,0,data_done_6);
    __buffer.advance(sizeof(zero.u32));
    if (__buffer.is_memberdump())
    {
      printf("%s%08" PRIx32 "%s: zero ", CT_OUT(BOLD), zero.u32, CT_OUT(NORM));
    ...
    if ((zero.ze != 0))
    {
      ...
      READ_FROM_BUFFER_FULL(903,uint32 ,ch_data,ch_data.u32,65);
      CHECK_BITS_EQUAL(899,ch_data.unnamed_22_29,16);
      CHECK_BITS_EQUAL(900,ch_data.unnamed_30_31,0);
      {
        typedef __typeof__(*(&(data))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = data.insert_index(902,((ch_data.trig * 32) + ch_data.channel));
        __item.value = ch_data.value;
      }
      if (__buffer.is_memberdump())
      {
  ...
  READ_FROM_BUFFER_FULL(912,uint32 ,end_of_event,end_of_event.u32,66);
  CHECK_BITS_EQUAL(911,end_of_event.unnamed_30_31,3);
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: end_of_event ", CT_OUT(BOLD), end_of_event.u32, CT_OUT(NORM));
    printf(".counter=%s%8" PRIx64 "%s ", CT_OUT(BOLD), (uint64_t)  end_of_event.counter, CT_OUT(NORM));
...
void SIS_3820_FRS::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(928,uint32 ,custom_header,custom_header.u32,68);
  if (__buffer.is_memberdump())
  {
  ...
  for (uint32 index = 0; index < (uint32) (custom_header.nchs); ++index)
  {
    ...
    if ((1 == custom_header.data_format))
    {
      ...
      READ_FROM_BUFFER_FULL(934,uint32 ,event,event.u32,69);
      if (__buffer.is_memberdump())
      {
...

      {
        typedef __typeof__(*(&(data))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = data.insert_index(935,index);
    ...
    if (((0 == custom_header.data_format) || (3 == custom_header.data_format)))
    {
      ...
      READ_FROM_BUFFER_FULL(943,uint32 ,event,event.u32,70);
      CHECK_BITS_EQUAL(941,event.unnamed_29_29,0);
      if (__buffer.is_memberdump())
      {
        printf("%s%08" PRIx32 "%s: event ", CT_OUT(BOLD), event.u32, CT_OUT(NORM));
...

      {
        typedef __typeof__(*(&(data))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = data.insert_index(944,event.channel);
        __item.value = event.val;
      }
    }
  }
...
void TAMEX4_SFP::__unpack(__data_src_t &__buffer,uint32 sfp,uint32 card)
{
  ...
  for (uint32 i = 0; i < (uint32) (((data_size.bytes / 4) - 3)); ++i)
  {
    ...
    do
    {
      ...
      {
        case 1:
          CHECK_SPURIOUS_MATCH_DECL(208,spurious_match_abort_loop_1,TAMEX4_EPOCH_DATA,/*sfp*/sfp,/*card*/card/*,time_coarse:member*//*,time_fine:member*//*,time_edge:member*//*,time_channel:member*//*,time_epoch:member*/);
          ...
          break;
        case 2:
          CHECK_SPURIOUS_MATCH_DECL(209,spurious_match_abort_loop_1,TAMEX4_TIME_DATA,/*sfp*/sfp,/*card*/card/*,time_coarse:member*//*,time_fine:member*//*,time_edge:member*//*,time_channel:member*//*,time_epoch:member*/);
                                                    ...
                                                    ,raw_array_multi_zero_suppress<DATA8,DATA8,128,128> &leadOrTrail)
{
  ...
  READ_FROM_BUFFER_FULL(570,uint32 ,tdc_data,tdc_data.u32,86);
  CHECK_BITS_EQUAL(565,tdc_data.unnamed_27_31,0);
  {
    {
      typedef __typeof__(*(&(data))) __array_t;
      typedef typename __array_t::item_t __item_t;
      __item_t &__item = data.insert_index(567,tdc_data.chn);
      __item.value = tdc_data.tdc;
    }
    {
      typedef __typeof__(*(&(leadOrTrail))) __array_t;
      typedef typename __array_t::item_t __item_t;
      __item_t &__item = leadOrTrail.insert_index(568,tdc_data.chn);
      __item.value = tdc_data.lot;
    }
  }
  if (__buffer.is_memberdump())
...
void VME_CAEN_V7X5_FRS::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(791,uint32 ,header,header.u32,100);
  CHECK_BITS_EQUAL(789,header.unnamed_24_26,2);
  CHECK_UNNAMED_BITS_ZERO(791,header.u32,0x0000c000);
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: header ", CT_OUT(BOLD), header.u32, CT_OUT(NORM));
  ...
  for (uint32 index = 0; index < (uint32) (header.count); ++index)
  {
    ...
    READ_FROM_BUFFER_FULL(810,uint32 ,ch_data,ch_data.u32,101);
    CHECK_BITS_EQUAL(804,ch_data.unnamed_24_26,0);
    {
      {
        typedef __typeof__(*(&(geo))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = geo.insert_index(807,index);
        __item.value = ch_data.geom;
      }
      {
        typedef __typeof__(*(&(channel))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = channel.insert_index(808,index);
        __item.value = ch_data.channel;
      }
      {
        typedef __typeof__(*(&(data))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = data.insert_index(809,index);
        __item.value = ch_data.value;
  ...
  READ_FROM_BUFFER_FULL(818,uint32 ,eob,eob.u32,102);
  CHECK_BITS_EQUAL(816,eob.unnamed_24_26,4);
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: eob ", CT_OUT(BOLD), eob.u32, CT_OUT(NORM));
    printf(".nothing=%s%6" PRIx64 "%s ", CT_OUT(BOLD), (uint64_t)  eob.nothing, CT_OUT(NORM));
  ...
  for (uint32 i = 0; i < (uint32) (2); ++i)
  {
    ...
    PEEK_FROM_BUFFER_FULL(827,uint32 ,eob2,eob2.u32,103);
    CHECK_JUMP_BITS_EQUAL(825,eob2.id,6,data_done_7);
    __buffer.advance(sizeof(eob2.u32));
    if (__buffer.is_memberdump())
    {
      printf("%s%08" PRIx32 "%s: eob2 ", CT_OUT(BOLD), eob2.u32, CT_OUT(NORM));
...
void VME_CAEN_V1190_FRS::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(651,uint32 ,header,header.u32,105);
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: header ", CT_OUT(BOLD), header.u32, CT_OUT(NORM));
    printf(".geo=%s%2" PRIx64 "%s ", CT_OUT(BOLD), (uint64_t)  header.geo, CT_OUT(NORM));
  ...
  if ((header.seven_f != 8))
  {
    ...
    READ_FROM_BUFFER_FULL(659,uint32 ,second1,second1.u32,106);
    CHECK_BITS_EQUAL(658,second1.unnamed_0_31,0xffffffff);
    if (__buffer.is_memberdump())
    {
    ...
    READ_FROM_BUFFER_FULL(666,uint32 ,real_header,real_header.u32,107);
    CHECK_BITS_EQUAL(665,real_header.unnamed_27_31,8);
    if (__buffer.is_memberdump())
    {
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(675,uint32,__match_peek);
    // differ = 38000000 : 27 28 29
    uint32 __match_index = 0 | /* 27,29 */ ((__match_peek >> 27) & 0x00000007);
    static const sint8 __match_index_array[8] = { 2, 1, 0, 4, 3, 0, 0, 0, };
    __match_no = __match_index_array[__match_index];
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(671,spurious_match_abort_loop_2,TDC_HEADER);
        UNPACK_DECL(671,TDC_HEADER,tdc_header);
        break;
      case 2:
        CHECK_SPURIOUS_MATCH_DECL(672,spurious_match_abort_loop_2,TDC_DATA_V1190/*,data:member*//*,leadOrTrail:member*/);
        UNPACK_DECL(672,TDC_DATA_V1190,measurement,/*data*/data,/*leadOrTrail*/leadOrTrail);
        break;
      case 3:
        CHECK_SPURIOUS_MATCH_DECL(673,spurious_match_abort_loop_2,TDC_ERROR);
        UNPACK_DECL(673,TDC_ERROR,tdc_error);
        break;
      case 4:
        CHECK_SPURIOUS_MATCH_DECL(674,spurious_match_abort_loop_2,TDC_TRAILER);
        UNPACK_DECL(674,TDC_TRAILER,tdc_trailer);
        break;
    }
  }
  ...
  PEEK_FROM_BUFFER_FULL(682,uint32 ,ext_time_tag,ext_time_tag.u32,108);
  CHECK_JUMP_BITS_EQUAL(681,ext_time_tag.unnamed_27_31,17,data_done_8);
  __buffer.advance(sizeof(ext_time_tag.u32));
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: ext_time_tag ", CT_OUT(BOLD), ext_time_tag.u32, CT_OUT(NORM));
  ...
  READ_FROM_BUFFER_FULL(693,uint32 ,trailer,trailer.u32,109);
  CHECK_BITS_EQUAL(692,trailer.unnamed_27_31,16);
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: trailer ", CT_OUT(BOLD), trailer.u32, CT_OUT(NORM));
    printf(".geo=%s%2" PRIx64 "%s ", CT_OUT(BOLD), (uint64_t)  trailer.geo, CT_OUT(NORM));
  ...
  READ_FROM_BUFFER(695,uint32 ,eob,110);
  data_done_9:;
}
...
void TPC_CRATE_DATA::__unpack(__data_src_t &__buffer)
{
  ...
  // barrier[0] = BARRIER();
  UNPACK_DECL(1038,BARRIER,barrier[0]);
  // v775 = VME_CAEN_V7X5_FRS();
  UNPACK_DECL(1039,VME_CAEN_V7X5_FRS,v775);
  // barrier[1] = BARRIER();
  UNPACK_DECL(1041,BARRIER,barrier[1]);
  // v785 = VME_CAEN_V7X5_FRS();
  UNPACK_DECL(1042,VME_CAEN_V7X5_FRS,v785);
  // barrier[2] = BARRIER();
  UNPACK_DECL(1045,BARRIER,barrier[2]);
  // v1190 = VME_CAEN_V1190_FRS();
  UNPACK_DECL(1046,VME_CAEN_V1190_FRS,v1190);
}
...
void TRIG3EVENT::__unpack(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(1000,uint32 ,trig3,trig3.u32,112);
  CHECK_BITS_EQUAL(999,trig3.unnamed_0_31,0x20202020);
  if (__buffer.is_memberdump())
  {
...
void USER_CRATE_DATA::__unpack(__data_src_t &__buffer)
{
  ...
  // barrier[0] = BARRIER();
  UNPACK_DECL(1052,BARRIER,barrier[0]);
  // v830 = VME_CAEN_V830_FRS();
  UNPACK_DECL(1053,VME_CAEN_V830_FRS,v830);
  // filler[0] = ZERO_FILLER();
  UNPACK_DECL(1056,ZERO_FILLER,filler[0]);
  // barrier[1] = BARRIER();
  UNPACK_DECL(1057,BARRIER,barrier[1]);
  // v775[0] = VME_CAEN_V7X5_FRS();
  UNPACK_DECL(1058,VME_CAEN_V7X5_FRS,v775[0]);
  // barrier[2] = BARRIER();
  UNPACK_DECL(1060,BARRIER,barrier[2]);
  // v775[1] = VME_CAEN_V7X5_FRS();
  UNPACK_DECL(1061,VME_CAEN_V7X5_FRS,v775[1]);
  // barrier[3] = BARRIER();
  UNPACK_DECL(1063,BARRIER,barrier[3]);
  // v785[0] = VME_CAEN_V7X5_FRS();
  UNPACK_DECL(1064,VME_CAEN_V7X5_FRS,v785[0]);
  // barrier[4] = BARRIER();
  UNPACK_DECL(1066,BARRIER,barrier[4]);
  // v785[1] = VME_CAEN_V7X5_FRS();
  UNPACK_DECL(1067,VME_CAEN_V7X5_FRS,v785[1]);
}
...
void VFTX2::__unpack(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(963,uint32 ,custom_header,custom_header.u32,114);
  CHECK_BITS_EQUAL(959,custom_header.id,id);
  CHECK_BITS_EQUAL(962,custom_header.unnamed_24_31,171);
  CHECK_UNNAMED_BITS_ZERO(963,custom_header.u32,0x00fc0000);
  if (__buffer.is_memberdump())
  {
    printf("%s%08" PRIx32 "%s: custom_header ", CT_OUT(BOLD), custom_header.u32, CT_OUT(NORM));
    printf(".id=%s%2" PRIx64 "%s ", CT_OUT(BOLD), (uint64_t)  custom_header.id, CT_OUT(NORM));
  ...
  // UINT32 trigger_window NOENCODE;
  uint32  trigger_window;READ_FROM_BUFFER(965,uint32 ,trigger_window,115);
  // UINT32 status_register NOENCODE;
  uint32  status_register;READ_FROM_BUFFER(966,uint32 ,status_register,116);
  ...
  READ_FROM_BUFFER_FULL(972,uint32 ,mvlc_header,mvlc_header.u32,117);
  CHECK_BITS_EQUAL(971,mvlc_header.mh,0xf500);
  if (__buffer.is_memberdump())
  {
  ...
  uint32  skip_event_header;READ_FROM_BUFFER(974,uint32 ,skip_event_header,118);
  ...
  for (uint32 index = 1; index < (uint32) (mvlc_header.words); ++index)
  {
    ...
    READ_FROM_BUFFER_FULL(989,uint32 ,event,event.u32,119);
    {
      {
        typedef __typeof__(*(&(time_fine))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = time_fine.insert_index(987,event.channel);
        __item.value = event.time_fine;
      }
      {
        typedef __typeof__(*(&(time_coarse))) __array_t;
        typedef typename __array_t::item_t __item_t;
        __item_t &__item = time_coarse.insert_index(988,event.channel);
...
void VFTX_CRATE_DATA::__unpack(__data_src_t &__buffer)
{
  ...
  do
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1085,spurious_match_abort_loop_3,MESYTEC_MQDC32_FRS);
  ...
  do
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1089,spurious_match_abort_loop_4,MESYTEC_MQDC32_FRS);
...
void bplast_subev::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1148,spurious_match_abort_loop_5,TAMEX4_PADDING);
  ...
  for ( ; ; )
  {
    ...
    switch (__match_no)
    {
      ...
      case 3:
        ...
        break;
      case 4:
        UNPACK_DECL(1155,TAMEX4_SFP,tamex[3],/*sfp*/0,/*card*/3);
        break;
      case 5:
        UNPACK_DECL(1156,TAMEX4_SFP,tamex[4],/*sfp*/0,/*card*/4);
        break;
    }
  }
}
...
void fatima_tamex_subev::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1133,spurious_match_abort_loop_6,TAMEX4_PADDING);
...
void febex_subev::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1116,spurious_match_abort_loop_7,FEBEX_PADDING);
...
void frs_main_subev::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1165,spurious_match_abort_loop_8,TIMESTAMP_WHITERABBIT,/*id*/0x100);
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1171,spurious_match_abort_loop_9,TRIG3EVENT);
...
void frs_tpc_subev::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1185,spurious_match_abort_loop_10,TRIG3EVENT);
...
void frs_user_subev::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1199,spurious_match_abort_loop_11,TRIG3EVENT);
...
void frs_vftx_subev::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(1213,spurious_match_abort_loop_12,TRIG3EVENT);
