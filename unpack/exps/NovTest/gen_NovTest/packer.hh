...
/** BEGIN_PACKER *******************************************************
 *
 * Event packer for FEBEX_BAD_EVENT.
 *
 * Do not edit - automatically generated.
 */
...
// FEBEX_BAD_EVENT()
template<typename __data_dest_t>
void PACKER_FEBEX_BAD_EVENT::__packer(__data_dest_t &__buffer)
{
  // UINT32 bad NOENCODE
  // {
    //  0_31: 0xbad00bad;
...
FORCE_IMPL_DATA_SRC_FCN(void,FEBEX_BAD_EVENT::__packer);
...
void PACKER_VME_CAEN_V1290_FRS::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(605,TDC_HEADER,tdc_header);
    PACK_DECL(606,TDC_DATA_V1290,measurement,/*data*/data,/*leadOrTrail*/leadOrTrail);
    PACK_DECL(607,TDC_ERROR,tdc_err);
    PACK_DECL(608,TDC_TRAILER,tdc_trailer);
  }
...
{
  // barrier[0] = BARRIER();
  PACK_DECL(1020,BARRIER,barrier[0]);
  // v830 = VME_CAEN_V830_FRS();
  PACK_DECL(1021,VME_CAEN_V830_FRS,v830);
  // filler[0] = ZERO_FILLER();
  PACK_DECL(1023,ZERO_FILLER,filler[0]);
  // barrier[1] = BARRIER();
  PACK_DECL(1024,BARRIER,barrier[1]);
  // v792 = VME_CAEN_V792_FRS();
  PACK_DECL(1025,VME_CAEN_V792_FRS,v792);
  // barrier[2] = BARRIER();
  PACK_DECL(1027,BARRIER,barrier[2]);
  // v1290 = VME_CAEN_V1290_FRS();
  PACK_DECL(1028,VME_CAEN_V1290_FRS,v1290);
}
...
void PACKER_VME_CAEN_V1190_FRS::__packer(__data_dest_t &__buffer)
{
  ...
  // select several
    ...
    // tdc_trailer = TDC_TRAILER();
  {
    PACK_DECL(666,TDC_HEADER,tdc_header);
    PACK_DECL(667,TDC_DATA_V1190,measurement,/*data*/data,/*leadOrTrail*/leadOrTrail);
    PACK_DECL(668,TDC_ERROR,tdc_error);
    PACK_DECL(669,TDC_TRAILER,tdc_trailer);
  }
  // optional UINT32 ext_time_tag NOENCODE
  // {
    //  0_26: time_tag;
...
{
  // barrier[0] = BARRIER();
  PACK_DECL(1036,BARRIER,barrier[0]);
  // v775 = VME_CAEN_V7X5_FRS();
  PACK_DECL(1037,VME_CAEN_V7X5_FRS,v775);
  // barrier[1] = BARRIER();
  PACK_DECL(1039,BARRIER,barrier[1]);
  // v785 = VME_CAEN_V7X5_FRS();
  PACK_DECL(1040,VME_CAEN_V7X5_FRS,v785);
  // barrier[2] = BARRIER();
  PACK_DECL(1043,BARRIER,barrier[2]);
  // v1190 = VME_CAEN_V1190_FRS();
  PACK_DECL(1044,VME_CAEN_V1190_FRS,v1190);
}
...
{
  // barrier[0] = BARRIER();
  PACK_DECL(1051,BARRIER,barrier[0]);
  // v830 = VME_CAEN_V830_FRS();
  PACK_DECL(1052,VME_CAEN_V830_FRS,v830);
  // filler[0] = ZERO_FILLER();
  PACK_DECL(1055,ZERO_FILLER,filler[0]);
  // barrier[1] = BARRIER();
  PACK_DECL(1056,BARRIER,barrier[1]);
  // v775[0] = VME_CAEN_V7X5_FRS();
  PACK_DECL(1057,VME_CAEN_V7X5_FRS,v775[0]);
  // barrier[2] = BARRIER();
  PACK_DECL(1059,BARRIER,barrier[2]);
  // v775[1] = VME_CAEN_V7X5_FRS();
  PACK_DECL(1060,VME_CAEN_V7X5_FRS,v775[1]);
  // barrier[3] = BARRIER();
  PACK_DECL(1062,BARRIER,barrier[3]);
  // v785[0] = VME_CAEN_V7X5_FRS();
  PACK_DECL(1063,VME_CAEN_V7X5_FRS,v785[0]);
  // barrier[4] = BARRIER();
  PACK_DECL(1065,BARRIER,barrier[4]);
  // v785[1] = VME_CAEN_V7X5_FRS();
  PACK_DECL(1066,VME_CAEN_V7X5_FRS,v785[1]);
}
