...
/** BEGIN_STRUCTURES ***************************************************
 *
 * Event unpacker associated structures for FEBEX_BAD_EVENT.
 *
 * Do not edit - automatically generated.
 */
...
// FEBEX_BAD_EVENT()
#if !PACKER_CODE
# define DECLARED_UNPACK_FEBEX_BAD_EVENT
class FEBEX_BAD_EVENT
#else//PACKER_CODE
# define DECLARED_PACKER_FEBEX_BAD_EVENT
class PACKER_FEBEX_BAD_EVENT
#endif//PACKER_CODE
...
# endif//PACKER_CODE
  ...
  STRUCT_FCNS_DECL(FEBEX_BAD_EVENT);
#endif//!__PSDC__
};
