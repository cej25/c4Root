...
bool BARRIER::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(1004,uint32 ,barrier,barrier.u32,1);
  MATCH_BITS_RANGE(1003,barrier.ba,0xf52,0xf58);
  return true;
  return false;
}
...
bool DUMMY::__match(__data_src_t &__buffer)
{
  // UINT32 no NOENCODE;
  uint32  no;
  MATCH_READ_FROM_BUFFER(234,uint32 ,no,3);
  return true;
  return false;
}
...
/** BEGIN_MATCHER ******************************************************
 *
 * Event matcher for FEBEX_BAD_EVENT.
 *
 * Do not edit - automatically generated.
 */
...
// FEBEX_BAD_EVENT()
template<typename __data_src_t>
bool FEBEX_BAD_EVENT::__match(__data_src_t &__buffer)
{
  // UINT32 bad NOENCODE
  // {
    //  0_31: 0xbad00bad;
  ...
  MATCH_READ_FROM_BUFFER_FULL(242,uint32 ,bad,bad.u32,5);
  MATCH_BITS_EQUAL(241,bad.unnamed_0_31,0xbad00bad);
  return true;
  return false;
}
FORCE_IMPL_DATA_SRC_FCN(bool,FEBEX_BAD_EVENT::__match);
...
bool FEBEX_EVENT::__match(__data_src_t &__buffer,uint32 card)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(283,uint32 ,sumchannel,sumchannel.u32,16);
  MATCH_BITS_EQUAL(277,sumchannel.unnamed_0_7,52);
  MATCH_BITS_EQUAL(280,sumchannel.card,card);
  MATCH_BITS_EQUAL(281,sumchannel.unnamed_24_31,255);
  return true;
  return false;
}
...
bool FEBEX_EVENT_TRACES::__match(__data_src_t &__buffer,uint32 card)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(382,uint32 ,sumchannel,sumchannel.u32,32);
  MATCH_BITS_EQUAL(376,sumchannel.unnamed_0_7,52);
  MATCH_BITS_EQUAL(379,sumchannel.board_id,card);
  MATCH_BITS_EQUAL(380,sumchannel.unnamed_24_31,255);
  return true;
  return false;
}
...
bool VME_CAEN_V830_FRS::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(707,uint32 ,v830_header,v830_header.u32,37);
  MATCH_BITS_EQUAL(705,v830_header.unnamed_26_26,1);
  return true;
  return false;
}
...
bool ZERO_FILLER::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(1012,uint32 ,filler,filler.u32,39);
  MATCH_BITS_EQUAL(1011,filler.zero,0);
  return true;
  return false;
}
...
bool VME_CAEN_V792_FRS::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(735,uint32 ,v792_header,v792_header.u32,44);
  MATCH_BITS_EQUAL(730,v792_header.unnamed_14_15,0);
  MATCH_BITS_EQUAL(732,v792_header.unnamed_24_26,2);
  return true;
  return false;
}
...
bool TDC_HEADER::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(532,uint32 ,tdc_header,tdc_header.u32,46);
  MATCH_BITS_EQUAL(531,tdc_header.unnamed_27_31,1);
  return true;
  return false;
}
...
bool TDC_DATA_V1290::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(548,uint32 ,tdc_data,tdc_data.u32,48);
  MATCH_BITS_EQUAL(544,tdc_data.unnamed_27_31,0);
  {
  }
  return true;
  return false;
...
bool TDC_ERROR::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(577,uint32 ,tdc_err,tdc_err.u32,50);
  MATCH_BITS_EQUAL(576,tdc_err.unnamed_27_31,4);
  return true;
  return false;
}
...
bool TDC_TRAILER::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(589,uint32 ,tdc_trailer,tdc_trailer.u32,52);
  MATCH_BITS_EQUAL(588,tdc_trailer.unnamed_27_31,3);
  return true;
  return false;
}
...
bool VME_CAEN_V1290_FRS::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(601,uint32 ,header,header.u32,57);
  MATCH_BITS_EQUAL(600,header.unnamed_27_31,8);
  return true;
  return false;
}
...
{
  // barrier[0] = BARRIER();
  CHECK_MATCH_DECL(1020,BARRIER,barrier[0]);
  return true;
  return false;
}
...
bool MESYTEC_MQDC32_FRS::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(839,uint32 ,header,header.u32,62);
  MATCH_BITS_EQUAL(835,header.unnamed_12_14,0);
  MATCH_BITS_EQUAL(837,header.unnamed_24_29,0);
  MATCH_BITS_EQUAL(838,header.unnamed_30_31,1);
  MATCH_UNNAMED_BITS_ZERO(839,header.u32,0x00008000);
  return true;
  return false;
}
...
bool MESYTEC_MTDC32_FRS::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(877,uint32 ,header,header.u32,67);
  MATCH_BITS_EQUAL(875,header.unnamed_24_29,0);
  MATCH_BITS_EQUAL(876,header.unnamed_30_31,1);
  return true;
  return false;
}
...
bool SIS_3820_FRS::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(923,uint32 ,custom_header,custom_header.u32,71);
  return true;
  return false;
}
...
bool TDC_DATA_V1190::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(565,uint32 ,tdc_data,tdc_data.u32,87);
  MATCH_BITS_EQUAL(560,tdc_data.unnamed_27_31,0);
  {
  }
  return true;
  return false;
...
bool VME_CAEN_V7X5_FRS::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(786,uint32 ,header,header.u32,104);
  MATCH_BITS_EQUAL(784,header.unnamed_24_26,2);
  MATCH_UNNAMED_BITS_ZERO(786,header.u32,0x0000c000);
  return true;
  return false;
}
...
bool VME_CAEN_V1190_FRS::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(646,uint32 ,header,header.u32,111);
  return true;
  return false;
}
...
{
  // barrier[0] = BARRIER();
  CHECK_MATCH_DECL(1036,BARRIER,barrier[0]);
  return true;
  return false;
}
...
bool TRIG3EVENT::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(995,uint32 ,trig3,trig3.u32,113);
  MATCH_BITS_EQUAL(994,trig3.unnamed_0_31,0x20202020);
  return true;
  return false;
}
...
{
  // barrier[0] = BARRIER();
  CHECK_MATCH_DECL(1051,BARRIER,barrier[0]);
  return true;
  return false;
}
...
bool VFTX2::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(958,uint32 ,custom_header,custom_header.u32,120);
  MATCH_BITS_EQUAL(954,custom_header.id,id);
  MATCH_BITS_EQUAL(957,custom_header.unnamed_24_31,171);
  MATCH_UNNAMED_BITS_ZERO(958,custom_header.u32,0x00fc0000);
  return true;
  return false;
}
