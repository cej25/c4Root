...
#line 32 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
...
#line 119 "mc_gen_lisaext/y.tab.c"
...
#line 172 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                { append_list(&all_mc_defs,(yyvsp[0].nodes)); }
#line 1271 "mc_gen_lisaext/y.tab.c"
    break;

  case 4: /* stmt_list: stmt  */
#line 177 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                { (yyval.nodes) = create_list((yyvsp[0].node)); }
#line 1277 "mc_gen_lisaext/y.tab.c"
    break;

  case 5: /* stmt_list: stmt_list stmt  */
#line 178 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                { (yyval.nodes) = append_list((yyvsp[-1].nodes),(yyvsp[0].node)); }
#line 1283 "mc_gen_lisaext/y.tab.c"
    break;

  case 6: /* stmt: ';'  */
#line 183 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                                   { (yyval.node) = NULL; }
#line 1289 "mc_gen_lisaext/y.tab.c"
    break;

  case 7: /* stmt: signal_mapping  */
#line 184 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                                   { (yyval.node) = (yyvsp[0].map); }
#line 1295 "mc_gen_lisaext/y.tab.c"
    break;

  case 8: /* stmt: calib_param  */
#line 185 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                                   { (yyval.node) = (yyvsp[0].calib); }
#line 1301 "mc_gen_lisaext/y.tab.c"
    break;

  case 9: /* stmt: user_calib_param  */
#line 186 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                                   { (yyval.node) = (yyvsp[0].user_calib); }
#line 1307 "mc_gen_lisaext/y.tab.c"
    break;

  case 10: /* signal_mapping: SIGNAL_MAPPING '(' data_type ',' data_name ',' var_or_name ',' toggle_null var_or_name ')' ';'  */
#line 195 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
...
#line 1325 "mc_gen_lisaext/y.tab.c"
    break;

  case 11: /* signal_mapping: STICKY_MAPPING '(' data_type ',' data_name ',' var_or_name ',' toggle_null var_or_name ')' ';'  */
#line 209 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    const signal_id_info *src_info  =
...
#line 1343 "mc_gen_lisaext/y.tab.c"
    break;

  case 12: /* calib_param: CALIB_PARAM '(' IDENTIFIER ',' calib_type ',' value_vector_np ')' ';'  */
#line 232 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    signal_id id;
...
#line 1358 "mc_gen_lisaext/y.tab.c"
    break;

  case 13: /* calib_param: CALIB_PARAM '(' toggle IDENTIFIER ',' calib_type ',' value_vector_np ')' ';'  */
#line 243 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    signal_id id;
	    dissect_name(CURR_FILE_LINE,(yyvsp[-6].strValue),id);
	    const signal_id_info *src_info  =
...
#line 1373 "mc_gen_lisaext/y.tab.c"
    break;

  case 14: /* calib_param: CALIB_PARAM_C '(' var_or_name ',' calib_type ',' value_vector_np ')' ';'  */
#line 254 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    const signal_id_info *src_info  =
...
#line 1387 "mc_gen_lisaext/y.tab.c"
    break;

  case 15: /* calib_param: CALIB_PARAM_C '(' toggle var_or_name ',' calib_type ',' value_vector_np ')' ';'  */
#line 264 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    const signal_id_info *src_info  =
	      get_signal_id_info((yyvsp[-6].var),SID_MAP_RAW | SID_MAP_MIRROR_MAP);
	    const signal_id_info *dest_info =
...
#line 1401 "mc_gen_lisaext/y.tab.c"
    break;

  case 16: /* calib_param: var_or_name '=' calib_type '(' value_vector_np ')' ';'  */
#line 274 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    const signal_id_info *src_info  =
	      get_signal_id_info((yyvsp[-6].var),SID_MAP_RAW | SID_MAP_MIRROR_MAP);
	    const signal_id_info *dest_info =
...
#line 1415 "mc_gen_lisaext/y.tab.c"
    break;

  case 17: /* calib_param: toggle var_or_name '=' calib_type '(' value_vector_np ')' ';'  */
#line 284 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    const signal_id_info *src_info  =
	      get_signal_id_info((yyvsp[-6].var),SID_MAP_RAW | SID_MAP_MIRROR_MAP);
	    const signal_id_info *dest_info =
...
#line 1429 "mc_gen_lisaext/y.tab.c"
    break;

  case 18: /* user_calib_param: CALIB_PARAM '(' IDENTIFIER ',' value_vector_np ')' ';'  */
#line 297 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    signal_id id;
...
#line 1441 "mc_gen_lisaext/y.tab.c"
    break;

  case 19: /* user_calib_param: CALIB_PARAM_C '(' var_or_name ',' value_vector_np ')' ';'  */
#line 305 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    const signal_id_info *dest_info =
...
#line 1452 "mc_gen_lisaext/y.tab.c"
    break;

  case 20: /* user_calib_param: var_or_name '=' value_vector_np_single ';'  */
#line 312 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    const signal_id_info *dest_info =
...
#line 1463 "mc_gen_lisaext/y.tab.c"
    break;

  case 21: /* user_calib_param: var_or_name '=' '{' value_vector_np '}' ';'  */
#line 319 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    const signal_id_info *dest_info =
...
#line 1474 "mc_gen_lisaext/y.tab.c"
    break;

  case 22: /* calib_type: IDENTIFIER  */
#line 336 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                     { (yyval.iValue) = calib_param_type((yyvsp[0].strValue));
	    if (!(yyval.iValue)) { yyerror("Unknown calibration type."); YYERROR; } }
#line 1481 "mc_gen_lisaext/y.tab.c"
    break;

  case 23: /* data_type: IDENTIFIER  */
#line 343 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                     { (yyval.iValue) = 0; /* $$ = data_type($1); if (!$$) { yyerror("Unknown data type."); YYERROR; } */ }
#line 1487 "mc_gen_lisaext/y.tab.c"
    break;

  case 24: /* toggle_null: %empty  */
#line 347 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                      { (yyval.iValue) = 0; }
#line 1493 "mc_gen_lisaext/y.tab.c"
    break;

  case 26: /* toggle: TOGGLE INTEGER ':'  */
#line 352 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                             {
...
#line 1505 "mc_gen_lisaext/y.tab.c"
    break;

  case 27: /* var_or_name: var_ident_rec  */
#line 362 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                        { (yyval.var) = new signal_id(); (yyval.var)->take_over((yyvsp[0].var_vect)); /* Note: this deletes $1! */ }
#line 1511 "mc_gen_lisaext/y.tab.c"
    break;

  case 28: /* data_name: IDENTIFIER  */
#line 366 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                     { (yyval.var) = NULL; /* $$ = new signal_id(); dissect_name(0,$1,*$$); */ }
#line 1517 "mc_gen_lisaext/y.tab.c"
    break;

  case 29: /* var_ident_rec: var_ident  */
#line 370 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                      { (yyval.var_vect) = (yyvsp[0].var_vect); }
#line 1523 "mc_gen_lisaext/y.tab.c"
    break;

  case 30: /* var_ident_rec: var_ident_rec '.' var_ident  */
#line 371 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
...
#line 1529 "mc_gen_lisaext/y.tab.c"
    break;

  case 31: /* var_ident: IDENTIFIER array_spec_list_null  */
#line 376 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
...
#line 1543 "mc_gen_lisaext/y.tab.c"
    break;

  case 32: /* array_spec_list_null: %empty  */
#line 388 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                       { (yyval.var_vect) = NULL; }
#line 1549 "mc_gen_lisaext/y.tab.c"
    break;

  case 33: /* array_spec_list_null: array_spec_list  */
#line 389 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                       { (yyval.var_vect) = (yyvsp[0].var_vect); }
#line 1555 "mc_gen_lisaext/y.tab.c"
    break;

  case 34: /* array_spec_list: array_spec  */
#line 393 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                       { (yyval.var_vect) = new sig_part_ptr_vector; (yyval.var_vect)->push_back((yyvsp[0].var_part)); }
#line 1561 "mc_gen_lisaext/y.tab.c"
    break;

  case 35: /* array_spec_list: array_spec_list array_spec  */
#line 394 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                       { (yyvsp[-1].var_vect)->push_back((yyvsp[0].var_part)); (yyval.var_vect) = (yyvsp[-1].var_vect); }
#line 1567 "mc_gen_lisaext/y.tab.c"
    break;

  case 36: /* array_spec: '[' INTEGER ']'  */
#line 398 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                       { (yyval.var_part) = new sig_part((yyvsp[-1].iValue)); }
#line 1573 "mc_gen_lisaext/y.tab.c"
    break;

  case 37: /* value_vector_np: value_vector_np_single  */
#line 410 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                            { (yyval.v_double_unit) = (yyvsp[0].v_double_unit); }
#line 1579 "mc_gen_lisaext/y.tab.c"
    break;

  case 38: /* value_vector_np: value_vector_np ',' value_unit  */
#line 411 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                            { (yyval.v_double_unit) = (yyvsp[-2].v_double_unit); (yyval.v_double_unit)->push_back((yyvsp[0].du)); }
#line 1585 "mc_gen_lisaext/y.tab.c"
    break;

  case 39: /* value_vector_np_single: value_unit  */
#line 415 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                            { (yyval.v_double_unit) = new vect_double_unit; (yyval.v_double_unit)->push_back((yyvsp[0].du)); }
#line 1591 "mc_gen_lisaext/y.tab.c"
    break;

  case 40: /* value_unit: value  */
#line 419 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.du)._value = (yyvsp[0].fValue); (yyval.du)._unit = NULL; }
#line 1597 "mc_gen_lisaext/y.tab.c"
    break;

  case 41: /* value_unit: value unit  */
#line 420 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.du)._value = (yyvsp[-1].fValue); (yyval.du)._unit = insert_units_exp(CURR_FILE_LINE,(yyvsp[0].strValue)); }
#line 1603 "mc_gen_lisaext/y.tab.c"
    break;

  case 42: /* value: DOUBLE  */
#line 425 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[0].fValue); }
#line 1609 "mc_gen_lisaext/y.tab.c"
    break;

  case 43: /* value: INTEGER  */
#line 426 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[0].iValue); }
#line 1615 "mc_gen_lisaext/y.tab.c"
    break;

  case 44: /* value: '-' value  */
#line 427 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = -(yyvsp[0].fValue); }
#line 1621 "mc_gen_lisaext/y.tab.c"
    break;

  case 45: /* value: '+' value  */
#line 428 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[0].fValue); }
#line 1627 "mc_gen_lisaext/y.tab.c"
    break;

  case 46: /* value: value '+' value  */
#line 429 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[-2].fValue) + (yyvsp[0].fValue); }
#line 1633 "mc_gen_lisaext/y.tab.c"
    break;

  case 47: /* value: value '-' value  */
#line 430 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[-2].fValue) - (yyvsp[0].fValue); }
#line 1639 "mc_gen_lisaext/y.tab.c"
    break;

  case 48: /* value: value '*' value  */
#line 431 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[-2].fValue) * (yyvsp[0].fValue); }
#line 1645 "mc_gen_lisaext/y.tab.c"
    break;

  case 49: /* value: value '/' value  */
#line 433 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
          {
	    if ((yyvsp[0].fValue) == 0.0)
	      yyerror("Warning: Division by zero.");
	    (yyval.fValue) = (yyvsp[-2].fValue) / (yyvsp[0].fValue);
	  }
#line 1655 "mc_gen_lisaext/y.tab.c"
    break;

  case 50: /* value: '(' value ')'  */
#line 438 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                  { (yyval.fValue) = (yyvsp[-1].fValue); }
#line 1661 "mc_gen_lisaext/y.tab.c"
    break;

  case 51: /* unit: STRING  */
#line 443 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                        { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1667 "mc_gen_lisaext/y.tab.c"
    break;

  case 52: /* unit: unit_part  */
#line 444 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                        { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1673 "mc_gen_lisaext/y.tab.c"
    break;

  case 53: /* unit: '/' unit_part  */
#line 445 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                        { (yyval.strValue) = find_concat_str_strings("/",(yyvsp[0].strValue),""); }
#line 1679 "mc_gen_lisaext/y.tab.c"
    break;

  case 54: /* unit_part: unit_part_many  */
#line 449 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                       { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1685 "mc_gen_lisaext/y.tab.c"
    break;

  case 55: /* unit_part: unit_part_many '*' unit_part  */
#line 450 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                       { (yyval.strValue) = find_concat_str_strings((yyvsp[-2].strValue),"*",(yyvsp[0].strValue)); }
#line 1691 "mc_gen_lisaext/y.tab.c"
    break;

  case 56: /* unit_part: unit_part_many '/' unit_part  */
#line 451 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                       { (yyval.strValue) = find_concat_str_strings((yyvsp[-2].strValue),"/",(yyvsp[0].strValue)); }
#line 1697 "mc_gen_lisaext/y.tab.c"
    break;

  case 57: /* unit_part_many: unit_part_block  */
#line 455 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                         { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1703 "mc_gen_lisaext/y.tab.c"
    break;

  case 58: /* unit_part_many: unit_part_many unit_part_block  */
#line 456 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                         { (yyval.strValue) = find_concat_str_strings((yyvsp[-1].strValue)," ",(yyvsp[0].strValue)); }
#line 1709 "mc_gen_lisaext/y.tab.c"
    break;

  case 59: /* unit_part_block: IDENTIFIER  */
#line 460 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                 { (yyval.strValue) = (yyvsp[0].strValue); }
#line 1715 "mc_gen_lisaext/y.tab.c"
    break;

  case 60: /* unit_part_block: IDENTIFIER INTEGER  */
#line 461 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                 { char tmp[32];
	    sprintf (tmp,"%d",(yyvsp[0].iValue)); (yyval.strValue) = find_concat_str_strings((yyvsp[-1].strValue),tmp,""); }
#line 1722 "mc_gen_lisaext/y.tab.c"
    break;

  case 61: /* unit_part_block: IDENTIFIER '-' INTEGER  */
#line 463 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                 { char tmp[32];
	    sprintf (tmp,"%d",(yyvsp[0].iValue)); (yyval.strValue) = find_concat_str_strings((yyvsp[-2].strValue),"-",tmp); }
#line 1729 "mc_gen_lisaext/y.tab.c"
    break;

  case 62: /* unit_part_block: IDENTIFIER '^' INTEGER  */
#line 465 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                     { char tmp[32];
	    sprintf (tmp,"%d",(yyvsp[0].iValue)); (yyval.strValue) = find_concat_str_strings((yyvsp[-2].strValue),"^",tmp); }
#line 1736 "mc_gen_lisaext/y.tab.c"
    break;

  case 63: /* unit_part_block: IDENTIFIER '^' '-' INTEGER  */
#line 467 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
                                     { char tmp[32];
	    sprintf (tmp,"%d",(yyvsp[0].iValue)); (yyval.strValue) = find_concat_str_strings((yyvsp[-3].strValue),"^-",tmp); }
#line 1743 "mc_gen_lisaext/y.tab.c"
    break;


#line 1747 "mc_gen_lisaext/y.tab.c"
...
#line 471 "/u/gandolfo/c4/c4Root/unpack/exps/../../..//ucesb/mapcalib/mc_parser.y"
