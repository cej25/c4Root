...
SUBEVENT(mcp_tamex_event)
{
    ...
    select optional
    {
        ts = TIMESTAMP_WHITERABBIT(id = 0x400); //400 before  was 500 at GSI
    };
...
EVENT
{
    mcp = mcp_tamex_event(procid = 248); // 248 for real data, 100 during pulser test for finetime 50 for HISPEC 10
