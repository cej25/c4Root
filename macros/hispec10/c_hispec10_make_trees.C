...
{   
    ...
    TString filename = "/u/cjones/data/lustre/gamma/s092_s103_files/ts/run_0137_0001.lmd";

    TString outputpath = "./";
    TString outputFileName = outputpath + "run_0137_0001_tree.root";
