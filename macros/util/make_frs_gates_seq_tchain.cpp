...
bool Gate_Z_AoQ(TChain * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z, bool bool_sci42E_Z){
    ...
    evt->Draw("FrsHitData.fID_z41:FrsHitData.fID_AoQ_corr_s2s4>>h2_Z_vs_AoQ(2000,1.8,2.5,2000,35,50)",cuts);
    ...
    if (cut_Z_AoQ == nullptr){
        ...
        cut_Z_AoQ->SetVarY("FrsHitData.fID_z41");
        cut_Z_AoQ->SetVarX("FrsHitData.FrsHitData.fID_AoQ_corr_s2s4");
        return true;
...
bool Gate_Z_Z2(TChain * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z, bool bool_sci42E_Z){
    ...
    if (cut_Z_Z2 == nullptr){
        ...
        gROOT->FindObject("CUTG")->Delete();
        cut_Z_Z2->SetVarX("FrsHitData.fID_z41");
        cut_Z_Z2->SetVarY("FrsHitData.fID_z42");
...
bool Gate_x2_AoQ(TChain * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z, bool bool_sci42E_Z){
    ...
    evt->Draw("FrsHitData.fID_x2:FrsHitData.fID_AoQ_corr_s2s4>>h2_x2_vs_AoQ(1000,2.0,3.0,1000,-100,100)",cuts);
    ...
    if (cut_x2_AoQ == nullptr){
        ...
        gROOT->FindObject("CUTG")->Delete();
        cut_x2_AoQ->SetVarX("FrsHitData.fID_AoQ_corr_s2s4");
...
bool Gate_x4_AoQ(TChain * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z, bool bool_sci42E_Z){
    ...
    evt->Draw("FrsHitData.fID_x4:FrsHitData.fID_AoQ_corr_s2s4>>h2_x4_vs_AoQ(1000,2.0,3.0,1000,-100,100)",cuts);
    ...
    if (cut_x4_AoQ == nullptr){
        ...
        gROOT->FindObject("CUTG")->Delete();
        cut_x4_AoQ->SetVarX("FrsHitData.fID_AoQ_corr_s2s4");
...
bool Gate_dEdeg_Z(TChain * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z, bool bool_sci42E_Z){
    ...
    if (cut_dEdeg_Z == nullptr){
        ...
        gROOT->FindObject("CUTG")->Delete();
        cut_dEdeg_Z->SetVarX("FrsHitData.fID_z41");
        cut_dEdeg_Z->SetVarY("FrsHitData.fID_dEdeg_z41");
        std::cout << "Created gate: " << cut_dEdeg_Z->GetName() << std::endl;
        return true;
    }
}

bool Gate_sci42E_Z(TChain * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z, bool bool_sci42E_Z){
    ...
    evt->Draw("FrsHitData.fID_z41:FrsHitData.fsci_e_42>>h2_sci42E_Z(1000,0,2500,1000,60,70)",cuts);
    ...
    if (cut_sci42E_Z == nullptr){
        ...
        gROOT->FindObject("CUTG")->Delete();
        cut_sci42E_Z->SetVarY("FrsHitData.fID_z41");
...
void make_frs_gates_seq_tchain(TString infilename){
