...
bool Gate_Z_AoQ(TTree * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z){
    ...
    evt->Draw("FrsMultiHitData.fID_z41_mhtdc:FrsMultiHitData.fID_AoQ_s2s4_mhtdc>>h2_Z_vs_AoQ(2000,1.8,2.5,2000,35,50)",cuts);
    ...
    if (cut_Z_AoQ == nullptr){
        ...
        cut_Z_AoQ->SetVarY("FrsMultiHitData.fID_z41_mhtdc");
        cut_Z_AoQ->SetVarX("FrsMultiHitData.FrsMultiHitData.fID_AoQ_s2s4_mhtdc");
        return true;
...
bool Gate_Z_Z2(TTree * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z){
    ...
    evt->Draw("FrsMultiHitData.fID_z41_mhtdc:FrsMultiHitData.fID_z42_mhtdc>>h2_Z_vs_Z2(1e3,35,50,1e3,35,50)",cuts);
    ...
    if (cut_Z_Z2 == nullptr){
        ...
        gROOT->FindObject("CUTG")->Delete();
        cut_Z_Z2->SetVarX("FrsMultiHitData.fID_z41_mhtdc");
        cut_Z_Z2->SetVarY("FrsMultiHitData.fID_z42_mhtdc");
...
bool Gate_x2_AoQ(TTree * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z){
    ...
    if (cut_x2_AoQ == nullptr){
        ...
        gROOT->FindObject("CUTG")->Delete();
        cut_x2_AoQ->SetVarX("FrsMultiHitData.fID_AoQ_s2s4_mhtdc");
        cut_x2_AoQ->SetVarY("FrsMultiHitData.fID_s2x_s2s4_mhtdc");
...
bool Gate_x4_AoQ(TTree * evt, bool bool_Z_AoQ, bool  bool_Z_Z2, bool  bool_x2_AoQ, bool  bool_x4_AoQ, bool bool_dEdeg_Z){
    ...
    evt->Draw("FrsMultiHitData.fID_s4x_mhtdc:FrsMultiHitData.fID_AoQ_s2s4_mhtdc>>h2_x4_vs_AoQ(1000,2.0,3.0,1000,-100,100)",cuts);
    ...
    if (cut_x4_AoQ == nullptr){
        ...
        gROOT->FindObject("CUTG")->Delete();
        cut_x4_AoQ->SetVarX("FrsMultiHitData.fID_AoQ_s2s4_mhtdc");
...
void make_frs_gates_seq_mhtdc(TString infilename){
