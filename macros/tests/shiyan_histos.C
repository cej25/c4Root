...
extern "C"
{
    #include "/lustre/gamma/lisa_s092/c4Root/config/shiyan/frs/setup/setup_160_49_2025_conv.C"
}
...
void shiyan_histos(TString filename)
{   
    ...
    TString c4Root_path = "/lustre/gamma/lisa_s092/c4Root";
