...
{   
    ...
    TString filename = Form(inputpath + "LISAmp_10layers_%04d_0001.lmd", fileNumber);

    //___O U T P U T
    TString outputpath = "/u/gandolfo/data/test_c4/trace_ana/"; 
    TString outputFilename = Form(outputpath + "LISAmp_10layers_%04d_0001_MWDtree.root", fileNumber);
