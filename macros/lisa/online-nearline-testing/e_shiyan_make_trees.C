...
extern "C"
{
    ...
    #include "../../../config/shiyan/frs/setup/setup_103_019_2025_conv.C" //shiyan
}
...
{   
    ...
    TString filename = inputpath + "run_0122_0001.lmd";
    ...
    TString outputpath = "/u/gandolfo/data/shiyan_debug/";   //energy resolution data
    
    //TString outputFilename = outputpath + "test_run_0075.root";
    TString outputFilename = outputpath + "run_0122_0001_tree.root"; 
