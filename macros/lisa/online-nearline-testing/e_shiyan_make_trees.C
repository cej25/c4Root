...
{   
    ...
    TString filename = inputpath + "run_0005_0002.lmd";
    ...
    TString outputpath = "/u/gandolfo/data/shiyan_dedx/";   //energy resolution data
    
    //TString outputFilename = outputpath + "test_run_0075.root";
    TString outputFilename = outputpath + "run_0005_0002_tree.root"; 
