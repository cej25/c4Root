...
{   
    ...
    TString filename = inputpath + "run_0143_0001_tree_debug.root";  
    
    // ::: O U T P U T
    //TString outputpath = "/u/gandolfo/data/lustre/gamma/lisa_s092/histos/";
    TString outputpath = "/u/cjones/data/shiyan_HitData/";   //energy resolution output
    TString outputFilename = outputpath + "run_0143_0001_hit2histo_debug.root";
    ...
    // ::: LisaHit2Histo task - pass both FRS and LISA gates
    LisaHit2Histo* lisa_hit2histo = new LisaHit2Histo(fgs, lgs);
    run->AddTask(lisa_hit2histo);
